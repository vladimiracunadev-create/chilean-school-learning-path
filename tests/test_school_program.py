...
class SchoolProgramTests(unittest.TestCase):
    ...
    def test_catalog_truth(self):
        ...
        self.assertEqual(self.catalog["editorial_counts"]["borrador"], 873)
        self.assertEqual(self.catalog["editorial_counts"]["desarrollada"], 115)
        self.assertEqual(self.catalog["editorial_counts"]["integrada"], 68)
    ...
    def test_first_grade_separates_developed_content_from_drafts(self):
        ...
        self.assertEqual(sum(item["editorial_status"] == "desarrollada" for item in first_grade), 93)
        self.assertEqual(sum(item["editorial_status"] == "integrada" for item in first_grade), 68)
        self.assertEqual(sum(item["editorial_status"] == "borrador" for item in first_grade), 873)
        ...
        self.assertEqual(len(developed), 115)
