# FG-CITS-3y4-OAC-02 — Explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° medio · Formación General | Tecnología y sociedad | Objetivos de aprendizaje | modulo-electivo | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-12988}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica, telecomunicaciones, astronomía, física cuántica, entre otros) han permitido al ser humano ampliar sus capacidades sensoriales y su comprensión de fenómenos relacionados con la materia, los seres vivos y el entorno». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-12989}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-12990}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-12991}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-12992}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «explicar, basados en investigaciones y modelos, cómo los avances tecnológicos (en robótica,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/tecnologia-sociedad/4-medio-fg/fg-cits-3y4-oac-02)
- [Asignatura y nivel](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/tecnologia-sociedad/4-medio-fg)
- Snapshot: 2026-09-24
