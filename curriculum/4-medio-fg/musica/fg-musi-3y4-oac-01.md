# FG-MUSI-3y4-OAC-01 — Experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° medio · Formación General | Música | Objetivos de aprendizaje | electivo-de-artes | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-12900}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de producción musical (voz, objetos sonoros, instrumentos musicales y tecnologías)». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-12901}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-12902}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-12903}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversos estilos musicales contemporáneos, utilizando diferentes recursos de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/musica/4-medio-fg/fg-musi-3y4-oac-01)
