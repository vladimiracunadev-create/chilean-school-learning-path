# FG-MUSI-3y4-OAC-04 — Analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-12914}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios estéticos (lenguaje musical, aspectos técnicos, emociones, sensaciones e ideas que genera, entre otros), utilizando conceptos disciplinarios». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-12915}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 5: Practicar con apoyo {#cl-12916}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-12917}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-12918}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «analizar propósitos expresivos de obras musicales de diferentes estilos a partir de criterios…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/musica/4-medio-fg/fg-musi-3y4-oac-04)
