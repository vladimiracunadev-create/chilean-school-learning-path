# TE04 OA 01 — Crear diseños de objetos o sistemas tecnológicos simples para resolver problemas
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Tecnología | Diseñar, hacer y probar | formacion-general-comun | 6 clases de 90 min |
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-04383}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear diseños de objetos o sistemas tecnológicos simples para resolver problemas**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear diseños de objetos o sistemas tecnológicos simples para resolver problemas: desde diversos ámbitos tecnológicos y tópicos de otras asignaturas representando sus ideas a través de dibujos a mano alzada, dibujo técnico o usando TIC explorando y transformando productos existentes». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **crear diseños de objetos o sistemas tecnológicos simples para resolver problemas**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-04384}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 6: Practicar con apoyo {#cl-04385}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-04386}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-04387}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-04388}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear diseños de objetos o sistemas tecnológicos simples para resolver problemas» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/4-basico/te04-oa-01)
