# de Habilidad CN04 OAH f — Comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Ciencias Naturales | Analizar la evidencia y comunicar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos, informes y presentaciones usando TIC. Actitud
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-03388}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos, informes y presentaciones usando TIC. Actitud». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-03389}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-03390}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-03391}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «comunicar ideas, explicaciones, observaciones y mediciones, utilizando diagramas, modelos físicos,…» y demostrarlo mediante explicación o indagación con evidencia.
