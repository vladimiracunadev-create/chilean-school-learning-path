# de Habilidad CN04 OAH b — Planificar y llevar a cabo investigaciones guiadas experimentales y no experimentales
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Ciencias Naturales | Planificar y conducir una investigación | formacion-general-comun | 5 clases de 90 min |

## Qué se debe aprender
> Planificar y llevar a cabo investigaciones guiadas experimentales y no experimentales: obteniendo información para responder a preguntas dadas partir de diversas fuentes sobre la base de una pregunta formulada por ellos u otros estableciendo un procedimiento previo simple para responderla trabajando de forma individual o colaborativa.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-03367}
...
| Explicación | 20 min | Modela cómo abordar «Planificar y llevar a cabo investigaciones guiadas experimentales y no experimentales: obteniendo información para responder a preguntas dadas partir de diversas fuentes sobre la base de una pregunta formulada por ellos u otros estableciendo un procedimiento previo simple para responderla trabajando de forma individual o colaborativa». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 5: Comprender y modelar {#cl-03368}
...
### Clase 3 de 5: Practicar con apoyo {#cl-03369}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-03370}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-03371}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/4-basico)
