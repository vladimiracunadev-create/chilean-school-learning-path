# AR04 OA 01 — Crear trabajos de arte con un propósito expresivo personal y basados en la observación del
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-03243}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear trabajos de arte con un propósito expresivo personal y basados en la observación del**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear trabajos de arte con un propósito expresivo personal y basados en la observación del: entorno natural: naturaleza y paisaje americano; entorno cultural: América y sus tradiciones (cultura precolombina, tradiciones y artesanía americana); entorno artístico: arte precolombino y de movimientos artísticos como muralismo mexicano, naif y surrealismo en Chile, Latinoamérica y en el resto del mundo». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **crear trabajos de arte con un propósito expresivo personal y basados en la observación del**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-03244}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 6: Practicar con apoyo {#cl-03245}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-03246}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-03247}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-03248}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos de arte con un propósito expresivo personal y basados en la observación del» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/artes-visuales/4-basico/ar04-oa-01)
