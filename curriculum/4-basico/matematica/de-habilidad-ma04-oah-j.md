# de Habilidad MA04 OAH j — Modelar
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Matemática | Modelar | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-04235}
...
| Explicación | 20 min | Modela cómo abordar «Modelar: Expresar, a partir de representaciones pictóricas y explicaciones dadas, acciones y situaciones cotidianas en lenguaje matemático». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 4: Comprender y modelar {#cl-04236}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-04237}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-04238}
