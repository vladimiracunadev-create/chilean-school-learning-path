# MA04 OA 01 — Representar y describir números del 0 al 10 000
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04075}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números del 0 al 10 000» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **representar y describir números del 0 al 10 000**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Representar y describir números del 0 al 10 000:contándolos de 10 en 10, de 100 en 100, de 1 000 en 1 000;leyéndolos y escribiéndolos;representándolos en forma concreta, pictórica y simbólica; comparándolos y ordenándolos en la recta numérica o la tabla posicional; identificando el valor posicional de los dígitos hasta la decena de mil; componiendo y descomponiendo números naturales hasta 10 000 en forma aditiva, de acuerdo a su valor posicional». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **representar y describir números del 0 al 10 000**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04076}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números del 0 al 10 000» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04077}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números del 0 al 10 000» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04078}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números del 0 al 10 000» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04079}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números del 0 al 10 000» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/4-basico/ma04-oa-01)
