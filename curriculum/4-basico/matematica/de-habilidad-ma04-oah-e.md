...
| Explicación | 20 min | Modela cómo abordar «Argumentar y comunicar: Descubrir regularidades matemáticas -la estructura de las operaciones inversas, el valor posicional en el sistema decimal, patrones como los múltiplos- y comunicarlas a otros». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
