# MA04 OA 08 — Demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04108}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2: explicando que una fracción representa la parte de un todo o de un grupo de elementos y un lugar en la recta numérica describiendo situaciones en las cuales se puede usar fracciones mostrando que una fracción puede tener representaciones diferentes comparando y ordenando fracciones (por ejemplo: 1/100, 1/8, 1/5, 1/4, 1/2) con material concreto y pictórico». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04109}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04110}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04111}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04112}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprende las fracciones con denominadores 100, 12, 10, 8, 6, 5, 4, 3, 2» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/4-basico/ma04-oa-08)
