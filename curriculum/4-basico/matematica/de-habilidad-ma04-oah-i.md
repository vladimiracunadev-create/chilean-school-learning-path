# de Habilidad MA04 OAH i — Modelar
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Matemática | Modelar | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04230}
...
| Explicación | 20 min | Modela cómo abordar «Modelar: Aplicar, seleccionar, modificar y evaluar modelos que involucren las cuatro operaciones con números naturales y fracciones, la ubicación en la recta numérica y el plano y el análisis de datos». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04231}
...
### Clase 3 de 5: Practicar con apoyo {#cl-04232}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04233}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04234}
