# de Habilidad MA04 OAH m — Representar
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Matemática | Representar | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04247}
...
| Explicación | 20 min | Modela cómo abordar «Representar: Crear un problema real a partir de una expresión matemática, una ecuación o una representación». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04248}
...
### Clase 3 de 5: Practicar con apoyo {#cl-04249}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04250}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04251}
