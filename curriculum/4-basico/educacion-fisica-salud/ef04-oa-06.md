# EF04 OA 06 — Ejecutar actividades físicas de intensidad moderada a vigorosa que desarrollen la condición física…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 4° básico | Educación Física y Salud | Vida activa y saludable | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-03439}
...
| Explicación | 20 min | Modela cómo abordar «Ejecutar actividades físicas de intensidad moderada a vigorosa que desarrollen la condición física por medio de la práctica de ejercicios de resistencia cardiovascular, fuerza, flexibilidad y velocidad, mejorando sus resultados personales». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
### Clase 2 de 4: Comprender y modelar {#cl-03440}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-03441}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-03442}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/4-basico/ef04-oa-06)
