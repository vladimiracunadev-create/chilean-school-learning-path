# IN06 OA 14 — Escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Inglés | Expresión escrita | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-06319}
...
| Explicación | 20 min | Modela cómo abordar «Escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email, postal, agenda, invitación) y textos literarios (como cuentos, rimas, tiras cómicas) con el propósito de compartir información en torno a los temas del año». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 4: Comprender y modelar {#cl-06320}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-06321}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-06322}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/6-basico/in06-oa-14)
