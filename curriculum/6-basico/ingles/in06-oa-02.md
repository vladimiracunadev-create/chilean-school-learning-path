# IN06 OA 02 — Identificar en los textos escuchados
...
> Identificar en los textos escuchados: tema e ideas generales información específica asociada a personas, lugares, tiempo y acciones palabras, familias de palabras, expresiones de uso frecuente y vocabulario temático repetición de sonidos y sonidos propios del idioma inglés que interfieren con la comunicación como los sonidos ch/sh en palabras como chip/ship ; b/v en palabras como boat/vote .
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-06263}
...
| Explicación | 20 min | Modela cómo abordar «Identificar en los textos escuchados: tema e ideas generales información específica asociada a personas, lugares, tiempo y acciones palabras, familias de palabras, expresiones de uso frecuente y vocabulario temático repetición de sonidos y sonidos propios del idioma inglés que interfieren con la comunicación como los sonidos ch/sh en palabras como chip/ship ; b/v en palabras como boat/vote ». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-06264}
...
### Clase 3 de 5: Practicar con apoyo {#cl-06265}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-06266}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-06267}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/6-basico/in06-oa-02)
