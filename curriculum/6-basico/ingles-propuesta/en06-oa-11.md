# EN06 OA 11 — Demostrar conocimiento y uso del vocabulario aprendido, por ejemplo
...
> Demostrar conocimiento y uso del vocabulario aprendido, por ejemplo: vocabulario temático palabras de uso frecuente expresiones de uso común asociadas a las funciones del nivel (por ejemplo: that's cool, great!).
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-06399}
...
| Explicación | 20 min | Modela cómo abordar «Demostrar conocimiento y uso del vocabulario aprendido, por ejemplo: vocabulario temático palabras de uso frecuente expresiones de uso común asociadas a las funciones del nivel (por ejemplo: that's cool, great!)». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 4: Comprender y modelar {#cl-06400}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-06401}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-06402}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/6-basico/en06-oa-11)
