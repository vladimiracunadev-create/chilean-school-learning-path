# EF06 OA 09 — Practicar actividades físicas en forma segura, demostrando la adquisición de hábitos de higiene,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Educación Física y Salud | Vida activa y saludable | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-05999}
...
| Explicación | 20 min | Modela cómo abordar «Practicar actividades físicas en forma segura, demostrando la adquisición de hábitos de higiene, posturales y de vida saludable, como ducharse después de realizar actividad física, utilizar una ropa distinta para la clase, mantener una correcta postura, utilizar protectores solares e hidratarse con agua antes, durante y después de la clase». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
### Clase 2 de 5: Comprender y modelar {#cl-06000}
...
### Clase 3 de 5: Practicar con apoyo {#cl-06001}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-06002}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-06003}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/6-basico/ef06-oa-09)
