# de Habilidad CN06 OAH c — Medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Ciencias Naturales | Planificar y conducir una investigación | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05916}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de medida, identificando patrones simples y usando las TIC cuando corresponda». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05917}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05918}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05919}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…» y demostrarlo mediante explicación o indagación con evidencia.
