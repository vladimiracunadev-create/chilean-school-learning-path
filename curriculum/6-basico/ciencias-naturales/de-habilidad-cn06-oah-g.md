# de Habilidad CN06 OAH g — Reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Ciencias Naturales | Analizar la evidencia y comunicar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a mejorar en sus procedimientos. Actitud
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05936}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a mejorar en sus procedimientos. Actitud». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05937}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05938}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05939}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «reflexionar, comunicar y proponer mejoras en sus investigaciones, identificando errores y aspectos a…» y demostrarlo mediante explicación o indagación con evidencia.
