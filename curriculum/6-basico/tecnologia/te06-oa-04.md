# TE06 OA 04 — Probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-07111}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos, aplicando criterios de funcionamiento, técnicos, medioambientales, estéticos y de seguridad, dialogando sobre sus resultados y aplicando correcciones según corresponda». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-07112}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 6: Practicar con apoyo {#cl-07113}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-07114}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-07115}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-07116}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «probar y evaluar la calidad de los trabajos propios o de otros, de forma individual o en equipos,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/6-basico/te06-oa-04)
