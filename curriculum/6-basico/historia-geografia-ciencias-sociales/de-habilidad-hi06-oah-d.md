# de Habilidad HI06 OAH d — Usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-06176}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio geográfico, como regiones, climas, paisajes, población, recursos y riesgos naturales». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-06177}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-06178}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-06179}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar herramientas geográficas para ubicar, caracterizar y relacionar elementos del espacio…» y demostrarlo mediante explicación o indagación con evidencia.
