# de Habilidad HI06 OAH b — Aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Historia, Geografía y Ciencias Sociales | Pensamiento temporal y espacial | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-06167}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos en relación con la historia de Chile». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-06168}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-06169}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-06170}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «aplicar conceptos relacionados con el tiempo (años, décadas, siglos, períodos, hitos) y utilizarlos…» y demostrarlo mediante explicación o indagación con evidencia.
