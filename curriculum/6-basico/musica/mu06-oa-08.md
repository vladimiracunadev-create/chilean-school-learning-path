# MU06 OA 08 — Reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Música | Reflexionar y contextualizar | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07022}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición, interpretación y creación, propia y de otros, con respeto y autocrítica». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07023}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07024}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07025}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «reflexionar sobre sus fortalezas y las áreas en que pueden mejorar en relación con la audición,…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/musica/6-basico/mu06-oa-08)
