# MU06 OA 05 — Improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Música | Interpretar y crear | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07009}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07010}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 5: Practicar con apoyo {#cl-07011}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07012}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07013}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear ideas musicales con un propósito dado y un adecuado dominio del lenguaje musical» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/musica/6-basico/mu06-oa-05)
