# de Habilidad MA06 OAH i — Modelar
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Matemática | Modelar | formacion-general-comun | 6 clases de 90 min |
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-06941}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **modelar**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Modelar: Aplicar, seleccionar, modificar y evaluar modelos que involucren las cuatro operaciones, la ubicación en la recta numérica y el plano, el análisis de datos, predicciones acerca de la probabilidad de ocurrencia de eventos, y reglas con lenguaje algebraico». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **modelar**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-06942}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 6: Practicar con apoyo {#cl-06943}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-06944}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-06945}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-06946}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «modelar» y demostrarlo mediante solución representada, explicada y comprobada.
