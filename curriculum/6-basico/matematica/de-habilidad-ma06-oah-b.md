# de Habilidad MA06 OAH b — Resolver problemas aplicando una variedad de estrategias, como
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Matemática | Resolver problemas | formacion-general-comun | 5 clases de 90 min |

## Qué se debe aprender
> Resolver problemas aplicando una variedad de estrategias, como: la estrategia de los 4 pasos: entender, planificar, hacer y comprobar comprender y evaluar estrategias de resolución de problemas de otros.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-06907}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «resolver problemas aplicando una variedad de estrategias, como» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **resolver problemas aplicando una variedad de estrategias, como**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Resolver problemas aplicando una variedad de estrategias, como: la estrategia de los 4 pasos: entender, planificar, hacer y comprobar comprender y evaluar estrategias de resolución de problemas de otros». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **resolver problemas aplicando una variedad de estrategias, como**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-06908}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «resolver problemas aplicando una variedad de estrategias, como» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-06909}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «resolver problemas aplicando una variedad de estrategias, como» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-06910}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «resolver problemas aplicando una variedad de estrategias, como» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-06911}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «resolver problemas aplicando una variedad de estrategias, como» y demostrarlo mediante solución representada, explicada y comprobada.
