# MA06 OA 19 — Calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Matemática | Medición | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 .
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-06878}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 » y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 **. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 ». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 **, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-06879}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 » y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-06880}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 » y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-06881}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «calcular el volumen de cubos y paralelepípedos, expresando el resultado en cm 3 , m 3 y mm 3 » y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/6-basico/ma06-oa-19)
