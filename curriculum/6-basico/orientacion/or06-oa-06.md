# OR06 OA 06 — Manifestar actitudes de solidaridad y respeto, que favorezcan la convivencia, como
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 6° básico | Orientación | Relaciones interpersonales | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07076}
...
| Explicación | 20 min | Modela cómo abordar «Manifestar actitudes de solidaridad y respeto, que favorezcan la convivencia, como: actuar en forma empática (poniéndose en el lugar del otro); utilizar un buen trato (por ejemplo, saludar, despedirse, pedir por favor); evitar y rechazar toda forma de violencia y discriminación, ya sea por etnia, género, religión, nacionalidad, etc.; respetar el derecho de todos a expresar opiniones y ser diferente; prestar ayuda especialmente a quien lo necesite; respetar el ambiente de aprendizaje». Hace visible el uso de bienestar, emoción, decisión, vínculo, límite, responsabilidad y red de apoyo y contrasta un ejemplo logrado con el error: forzar exposición personal; confundir consejo con decisión responsable. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07077}
...
### Clase 3 de 5: Practicar con apoyo {#cl-07078}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07079}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07080}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/orientacion/6-basico/or06-oa-06)
