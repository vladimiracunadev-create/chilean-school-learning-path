# EF03 OA 04 — Ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02277}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar limpios y ordenados los espacios, por ejemplo: jugar en plazas activas; jugar un partido en la plaza o la playa; realizar caminatas en el entorno natural; andar en bicicleta en un parque o en un camino rural». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02278}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 5: Practicar con apoyo {#cl-02279}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02280}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02281}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «ejecutar actividades físicas y/o lúdicas en diferentes entornos, aplicando medidas para conservar…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/3-basico/ef03-oa-04)
