# EF03 OA 01 — Demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Educación Física y Salud | Habilidades motrices | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02264}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción, manipulación y estabilidad en diferentes direcciones, alturas y niveles, ejemplo, correr y lanzar un objeto con una mano, caminar sobre una línea y realizar un giro de 180° en un pie». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02265}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 5: Practicar con apoyo {#cl-02266}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02267}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02268}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar capacidad para ejecutar de forma combinada las habilidades motrices básicas de locomoción,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/3-basico/ef03-oa-01)
