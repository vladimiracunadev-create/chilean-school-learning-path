# EF03 OA 11 — Practicar actividades físicas, demostrando comportamientos seguros, como
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Educación Física y Salud | Seguridad, juego limpio y liderazgo | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02307}
...
| Explicación | 20 min | Modela cómo abordar «Practicar actividades físicas, demostrando comportamientos seguros, como: participar en actividades de calentamiento en forma apropiada; escuchar y seguir instrucciones; mantener su posición dentro de los límites establecidos para la actividad; asegurar que el espacio está libre de obstáculos». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02308}
...
### Clase 3 de 5: Practicar con apoyo {#cl-02309}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02310}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02311}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/3-basico/ef03-oa-11)
