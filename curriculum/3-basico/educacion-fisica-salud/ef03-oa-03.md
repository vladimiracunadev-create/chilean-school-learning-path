# EF03 OA 03 — Practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02273}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales de juego, como avanzar y retroceder en bloque, recuperar el balón, acompañar la jugada y la visión periférica». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02274}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02275}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02276}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «practicar juegos pre-deportivos con reglas y espacios adaptados, aplicando los principios generales…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/3-basico/ef03-oa-03)
