# LE03 OA 15 — Escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02778}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02779}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-02780}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02781}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02782}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir cartas, instrucciones, afiches, reportes de una experiencia, entre otros, para lograr…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/3-basico/le03-oa-15)
