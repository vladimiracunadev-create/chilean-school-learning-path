# LE03 OA 08 — Asistir habitualmente a la biblioteca para satisfacer diversos propósitos (encontrar información,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Lenguaje y Comunicación | Lectura - Comprensión | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02746}
...
| Explicación | 20 min | Modela cómo abordar «Asistir habitualmente a la biblioteca para satisfacer diversos propósitos (encontrar información, elegir libros, estudiar o trabajar), cuidando el material en favor del uso común». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02747}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02748}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02749}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/3-basico/le03-oa-08)
