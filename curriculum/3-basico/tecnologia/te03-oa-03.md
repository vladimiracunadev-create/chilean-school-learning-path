# TE03 OA 03 — Elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Tecnología | Diseñar, hacer y probar | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-03200}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de: técnicas y herramientas para medir, marcar, cortar, plegar, unir, pegar, pintar, entre otras materiales como papeles, cartones, fibras, plásticos, cerámicos, desechos, entre otros». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-03201}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-03202}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-03203}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-03204}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico para resolver problemas, seleccionando y demostrando dominio de» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/3-basico/te03-oa-03)
