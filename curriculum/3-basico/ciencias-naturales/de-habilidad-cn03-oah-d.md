# de Habilidad CN03 OAH d — Usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Ciencias Naturales | Planificar y conducir una investigación | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02224}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros, para hacer observaciones y mediciones». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02225}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02226}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02227}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar materiales e instrumentos en forma segura y autónoma, como reglas, termómetros, entre otros,…» y demostrarlo mediante explicación o indagación con evidencia.
