# de Habilidad CN03 OAH a — Observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Ciencias Naturales | Observar y preguntar | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02228}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y eventos del entorno». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02229}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02230}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02231}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «observar, plantear preguntas, formular inferencias y predicciones, en forma guiada, sobre objetos y…» y demostrarlo mediante explicación o indagación con evidencia.
