# HI03 OA 12 — Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad)…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02393}
...
| Explicación | 20 min | Modela cómo abordar «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen valores y virtudes ciudadanas, como: la tolerancia y el respeto al otro (ejemplos: respetar las opiniones distintas distintas a las propias, mostrar disposición al diálogo, respetar expresiones de diversidad, como diferentes costumbres, creencias, origen étnico, nacionalidad, etc.) la empatía (ejemplos: demostrar cortesía con los demás, escuchar al otro, ayudar a quien lo necesite, etc)». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02394}
...
### Clase 3 de 5: Practicar con apoyo {#cl-02395}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02396}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02397}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/historia-geografia-ciencias-sociales/3-basico/hi03-oa-12)
