# de Habilidad HI03 OAH c — Comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02424}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y civilizaciones del pasado y del presente para identificar continuidades y cambios». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02425}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02426}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02427}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «comparar distintos aspectos (objetos, juegos, costumbres y actividades) entre sociedades y…» y demostrarlo mediante explicación o indagación con evidencia.
