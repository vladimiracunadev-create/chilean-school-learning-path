# de Habilidad HI03 OAH f — Obtener información sobre el pasado y el presente a partir de diversas fuentes dadas (como…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Historia, Geografía y Ciencias Sociales | Análisis y trabajo con fuentes de información | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02436}
...
| Explicación | 20 min | Modela cómo abordar «Obtener información sobre el pasado y el presente a partir de diversas fuentes dadas (como entrevistas, narraciones, medios audiovisuales, mapas, textos, imágenes, gráficos, tablas y pictogramas, entre otros), mediante preguntas dirigidas». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02437}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02438}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02439}
