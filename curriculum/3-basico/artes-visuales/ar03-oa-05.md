# AR03 OA 05 — Describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02128}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando criterios de uso de materiales, procedimientos técnicos y propósito expresivo». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02129}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02130}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02131}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «describir fortalezas y aspectos a mejorar en el trabajo de arte personal y de sus pares, usando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/artes-visuales/3-basico/ar03-oa-05)
