...
| Explicación | 20 min | Modela cómo abordar «Argumentar y comunicar: Describir una situación del entorno con una expresión matemática, con una ecuación o con una representación pictórica». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
