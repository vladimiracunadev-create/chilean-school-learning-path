# de Habilidad MA03 OAH k — Modelar
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-03051}
...
| Explicación | 20 min | Modela cómo abordar «Modelar: Identificar regularidades en expresiones numéricas y geométricas». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 4: Comprender y modelar {#cl-03052}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-03053}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-03054}
