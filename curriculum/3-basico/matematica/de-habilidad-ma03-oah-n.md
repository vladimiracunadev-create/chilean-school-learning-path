# de Habilidad MA03 OAH n — Representar
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° básico | Matemática | Representar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Representar: Transferir una situación de un nivel de representación a otro (por ejemplo: de lo concreto a lo pictórico y de lo pictórico a lo simbólico, y viceversa). Actitud
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-03064}
...
| Explicación | 20 min | Modela cómo abordar «Representar: Transferir una situación de un nivel de representación a otro (por ejemplo: de lo concreto a lo pictórico y de lo pictórico a lo simbólico, y viceversa). Actitud». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 4: Comprender y modelar {#cl-03065}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-03066}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-03067}
