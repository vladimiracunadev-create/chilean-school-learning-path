# de Actitud CN08 OAA E — Usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08636}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las explicaciones científicas y el procesamiento de evidencias, dando crédito al trabajo de otros y respetando la propiedad y la privacidad de las personas». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08637}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08638}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08639}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar de manera responsable y efectiva las tecnologías de la comunicación para favorecer las…» y demostrarlo mediante explicación o indagación con evidencia.
