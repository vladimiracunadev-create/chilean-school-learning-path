# de Habilidad CN08 OAH d — Planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Ciencias Naturales | Planificar y conducir una investigación | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08575}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas fuentes de información científica, considerando: La selección de instrumentos y materiales a usar de acuerdo a las variables presentes en el estudio. La manipulación de una variable. La explicación clara de procedimientos posibles de replicar». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08576}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-08577}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08578}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08579}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «planificar una investigación experimental sobre la base de una pregunta y/o problema y diversas…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ciencias-naturales/8-basico)
