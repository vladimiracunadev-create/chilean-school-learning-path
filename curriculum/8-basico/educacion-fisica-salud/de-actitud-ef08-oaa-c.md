# de Actitud EF08 OAA C — Trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08686}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando consejos y críticas». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08687}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08688}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08689}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «trabajar en equipo, asumiendo responsablemente roles y tareas, colaborando con otros y aceptando…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
