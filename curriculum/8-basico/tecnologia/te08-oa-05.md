# TE08 OA 05 — Examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…
...
> Examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades establecidas considerando los destinatarios, aspectos técnicos y funcionales.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-09604}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades establecidas considerando los destinatarios, aspectos técnicos y funcionales». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-09605}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-09606}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-09607}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «examinar soluciones tecnológicas existentes que respondan a las oportunidades o necesidades…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/8-basico/te08-oa-05)
