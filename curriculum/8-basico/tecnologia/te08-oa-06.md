# TE08 OA 06 — Establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Tecnología | Tecnología, ambiente y sociedad | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando aspectos éticos, ambientales y sociales, entre otros.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-09608}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando aspectos éticos, ambientales y sociales, entre otros». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-09609}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-09610}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-09611}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «establecer impactos positivos y/o negativos de las soluciones tecnológicas analizadas considerando…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/8-basico/te08-oa-06)
