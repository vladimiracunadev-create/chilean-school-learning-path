# LI08 OF F — Leer comprensivamente textos pertinentes al contexto social indígena actual
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Lengua Indígena | Comunicación escrita | segun-contexto-y-normativa | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09101}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «leer comprensivamente textos pertinentes al contexto social indígena actual» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **leer comprensivamente textos pertinentes al contexto social indígena actual**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Leer comprensivamente textos pertinentes al contexto social indígena actual». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **leer comprensivamente textos pertinentes al contexto social indígena actual**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09102}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «leer comprensivamente textos pertinentes al contexto social indígena actual» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09103}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «leer comprensivamente textos pertinentes al contexto social indígena actual» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09104}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «leer comprensivamente textos pertinentes al contexto social indígena actual» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09105}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «leer comprensivamente textos pertinentes al contexto social indígena actual» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/lengua-indigena/8-basico/li08-f)
