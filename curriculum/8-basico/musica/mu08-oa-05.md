# MU08 OA 05 — Improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Música | Interpretar y crear | formacion-general-comun | 5 clases de 90 min |

## Qué se debe aprender
> Improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones determinadas, dando énfasis a acompañamientos y variaciones rítmicas, melódicas y/o armónicas.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09487}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones determinadas, dando énfasis a acompañamientos y variaciones rítmicas, melódicas y/o armónicas». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09488}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09489}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09490}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09491}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «improvisar y crear música aplicando experiencias y conocimientos a partir de indicaciones…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/musica/8-basico/mu08-oa-05)
