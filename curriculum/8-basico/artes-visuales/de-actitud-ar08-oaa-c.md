# de Actitud AR08 OAA C — Demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08464}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando, imaginando y pensando divergentemente». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08465}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08466}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08467}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar disposición a expresarse visualmente y desarrollar su creatividad, experimentando,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
