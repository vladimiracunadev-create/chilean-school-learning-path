# AR08 OA 02 — Crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08432}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales sustentables en técnicas de impresión, papeles y textiles». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08433}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 5: Practicar con apoyo {#cl-08434}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08435}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08436}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales a partir de diferentes desafíos creativos, experimentando con materiales…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/artes-visuales/8-basico/ar08-oa-02)
