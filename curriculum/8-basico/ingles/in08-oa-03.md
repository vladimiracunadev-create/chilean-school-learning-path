# IN08 OA 03 — Identificar en los textos escuchados
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08924}
...
| Explicación | 20 min | Modela cómo abordar «Identificar en los textos escuchados: Propósito o finalidad del texto, tema e ideas generales. Información específica y detalles relevantes asociados a personas y sus acciones, lugares, tiempo, hablantes y situaciones. Pasos en instrucciones y procedimientos, secuencia de eventos, diferencia entre hecho y opinión y relaciones causa-efecto y condición». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08925}
...
### Clase 3 de 5: Practicar con apoyo {#cl-08926}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08927}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08928}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/8-basico/in08-oa-03)
