# HI08 OA 22 — Aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en Chile,…
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-08803}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en Chile, considerando el índice de desarrollo humano, la diversidad productiva, de intercambio y de consumo, las ventajas comparativas, la inserción en los mercados internacionales, y el desarrollo sustentable». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-08804}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 6: Practicar con apoyo {#cl-08805}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-08806}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-08807}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-08808}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «aplicar el concepto de desarrollo para analizar diversos aspectos de las regiones en chile,…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/historia-geografia-ciencias-sociales/8-basico/hi08-oa-22)
