# de Habilidad HI08 OAH d — Interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Historia, Geografía y Ciencias Sociales | Pensamiento temporal y espacial | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08837}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Interpretar datos e información geográfica, utilizando tecnología apropiada para identificar distribuciones espaciales y patrones (por ejemplo, población, cultivo, ciudades, regiones, entre otros), y explicar las relaciones entre estos». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08838}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-08839}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08840}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08841}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «interpretar datos e información geográfica, utilizando tecnología apropiada para identificar…» y demostrarlo mediante explicación o indagación con evidencia.
