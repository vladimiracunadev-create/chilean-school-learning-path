# de Habilidad MA08 OAH c — Utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 8° básico | Matemática | Resolver problemas | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-09397}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-09398}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-09399}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-09400}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «utilizar sus propias palabras, gráficos y símbolos matemáticos para presentar sus ideas o soluciones» y demostrarlo mediante solución representada, explicada y comprobada.
