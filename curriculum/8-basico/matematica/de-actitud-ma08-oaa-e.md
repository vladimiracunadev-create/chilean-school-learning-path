# de Actitud MA08 OAA E — Mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09460}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte de los datos cuantitativos en la comprensión de la realidad social». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09461}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09462}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09463}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09464}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «mostrar una actitud crítica al evaluar las evidencias e informaciones matemáticas y valorar el aporte…» y demostrarlo mediante solución representada, explicada y comprobada.
