...
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «mostrar que comprenden las operaciones de expresiones algebraicas» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **mostrar que comprenden las operaciones de expresiones algebraicas**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Mostrar que comprenden las operaciones de expresiones algebraicas: Representándolas de manera pictórica y simbólica. Relacionándolas con el área de cuadrados, rectángulos y volúmenes de paralelepípedos. Determinando formas factorizadas». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **mostrar que comprenden las operaciones de expresiones algebraicas**, explica una decisión y revisa su trabajo con los criterios. |
...
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «mostrar que comprenden las operaciones de expresiones algebraicas» y demostrarlo mediante solución representada, explicada y comprobada.
...
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «mostrar que comprenden las operaciones de expresiones algebraicas» y demostrarlo mediante solución representada, explicada y comprobada.
...
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «mostrar que comprenden las operaciones de expresiones algebraicas» y demostrarlo mediante solución representada, explicada y comprobada.
