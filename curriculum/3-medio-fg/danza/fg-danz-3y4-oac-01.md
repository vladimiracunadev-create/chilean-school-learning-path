# FG-DANZ-3y4-OAC-01 — Experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° medio · Formación General | Danza | Objetivos de aprendizaje | electivo-de-artes | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-12141}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando los diversos recursos y elementos del lenguaje de la danza». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-12142}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-12143}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-12144}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «experimentar el cuerpo y sus posibilidades de movimiento de manera consciente y expresiva, utilizando…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/danza/3-medio-fg/fg-danz-3y4-oac-01)
