# FG-ARTE-3y4-OAC-01 — Experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 3° medio · Formación General | Artes visuales | Objetivos de aprendizaje | electivo-de-artes | 4 clases de 90 min |

## Qué se debe aprender
> Experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración, las artes audiovisuales y multimediales.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-12053}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración, las artes audiovisuales y multimediales». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-12054}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-12055}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-12056}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «experimentar con diversidad de soportes, procedimientos y materiales utilizados en la ilustración,…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/artes-visuales/3-medio-fg/fg-arte-3y4-oac-01)
