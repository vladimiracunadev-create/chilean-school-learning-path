# FG-EFS1-3y4-OAC-01 — Aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…
...
> Aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y segura, en una variedad de actividades físicas que sean de su interés y en diferentes entornos.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-12206}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y segura, en una variedad de actividades físicas que sean de su interés y en diferentes entornos». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-12207}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-12208}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-12209}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «aplicar individual y colectivamente las habilidades motrices especializadas de manera creativa y…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/3o-4o-medio/educacion-fisica-salud-1/3-medio-fg/fg-efs1-3y4-oac-01)
