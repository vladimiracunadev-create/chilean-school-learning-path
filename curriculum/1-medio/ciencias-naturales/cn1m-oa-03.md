# CN1M OA 03 — Explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09700}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09701}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09702}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09703}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09704}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «explicar, basándose en evidencias, que la clasificación de la diversidad de organismos se construye a…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ciencias-naturales/1-medio/cn1m-oa-03)
