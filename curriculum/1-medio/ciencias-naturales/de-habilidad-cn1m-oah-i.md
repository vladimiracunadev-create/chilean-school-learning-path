# de Habilidad CN1M OAH i — Crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° medio | Ciencias Naturales | Procesar y analizar la evidencia | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09823}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar explicaciones sobre las relaciones entre las partes de un sistema». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09824}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09825}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09826}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09827}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear, seleccionar, usar y ajustar modelos para describir mecanismos y para predecir y apoyar…» y demostrarlo mediante explicación o indagación con evidencia.
