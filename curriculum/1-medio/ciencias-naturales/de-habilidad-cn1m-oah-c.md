# de Habilidad CN1M OAH c — Formular y fundamentar hipótesis comprobables, basándose en conocimiento científico
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-09798}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «formular y fundamentar hipótesis comprobables, basándose en conocimiento científico» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **formular y fundamentar hipótesis comprobables, basándose en conocimiento científico**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Formular y fundamentar hipótesis comprobables, basándose en conocimiento científico». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **formular y fundamentar hipótesis comprobables, basándose en conocimiento científico**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-09799}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «formular y fundamentar hipótesis comprobables, basándose en conocimiento científico» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-09800}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «formular y fundamentar hipótesis comprobables, basándose en conocimiento científico» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-09801}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «formular y fundamentar hipótesis comprobables, basándose en conocimiento científico» y demostrarlo mediante explicación o indagación con evidencia.
