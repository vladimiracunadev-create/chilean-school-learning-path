# CN1M OA 02 — Analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-09694}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es el resultado de la evolución, considerando: Evidencias de la evolución (como el registro fósil, las estructuras anatómicas homólogas, la embriología y las secuencias de ADN). Los postulados de la teoría de la selección natural. Los aportes de científicos como Darwin y Wallace a las teorías evolutivas». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-09695}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 6: Practicar con apoyo {#cl-09696}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-09697}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-09698}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-09699}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «analizar e interpretar datos para proveer de evidencias que apoyen que la diversidad de organismos es…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ciencias-naturales/1-medio/cn1m-oa-02)
