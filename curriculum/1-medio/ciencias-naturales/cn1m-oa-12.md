# CN1M OA 12 — Explorar y describir el funcionamiento del oído y del ojo humano, considerando
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-09745}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «explorar y describir el funcionamiento del oído y del ojo humano, considerando» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **explorar y describir el funcionamiento del oído y del ojo humano, considerando**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Explorar y describir el funcionamiento del oído y del ojo humano, considerando: La recepción de ondas sonoras y luminosas. El espectro sonoro y de la luz visible. Sus capacidades, limitaciones y consecuencias sociales. La tecnología correctiva (lentes y audífonos)». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **explorar y describir el funcionamiento del oído y del ojo humano, considerando**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-09746}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «explorar y describir el funcionamiento del oído y del ojo humano, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-09747}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «explorar y describir el funcionamiento del oído y del ojo humano, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-09748}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «explorar y describir el funcionamiento del oído y del ojo humano, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-09749}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «explorar y describir el funcionamiento del oído y del ojo humano, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ciencias-naturales/1-medio/cn1m-oa-12)
