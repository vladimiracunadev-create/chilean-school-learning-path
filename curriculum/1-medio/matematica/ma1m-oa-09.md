# MA1M OA 09 — Desarrollar el teorema de Tales mediante las propiedades de la homotecia, para aplicarlo en la…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-10553}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-10554}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-10555}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-10556}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «desarrollar el teorema de tales mediante las propiedades de la homotecia, para aplicarlo en la…» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/1-medio/ma1m-oa-09)
