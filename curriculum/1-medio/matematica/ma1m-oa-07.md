# MA1M OA 07 — Desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° medio | Matemática | Geometría | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10543}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono: Desplegando la red del cono para la fórmula del área de superficie. Experimentando de manera concreta para encontrar la relación entre el volumen del cilindro y el cono. Aplicando las fórmulas a la resolución de problemas geométricos y de la vida diaria». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10544}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10545}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10546}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10547}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «desarrollar las fórmulas para encontrar el área de la superficie y el volumen del cono» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/1-medio/ma1m-oa-07)
