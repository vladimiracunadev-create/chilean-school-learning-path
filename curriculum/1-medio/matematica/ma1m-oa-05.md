# MA1M OA 05 — Graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10534}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by; por ejemplo: un haz de rectas paralelas en el plano cartesiano, líneas de nivel en planos inclinados (techo), propagación de olas en el mar y la formación de algunas capas de rocas: Creando tablas de valores con a, b fijo y x, y variable. Representando una ecuación lineal dada por medio de un gráfico, de manera manual y/o con software educativo. Escribiendo la relación entre las variables de un gráfico dado; por ejemplo, variando c en la ecuación ax + by = c ; (a, b, c ϵ Q) (decimales hasta la décima)». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10535}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10536}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10537}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10538}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «graficar relaciones lineales en dos variables de la forma f(x, y) = ax + by» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/1-medio/ma1m-oa-05)
