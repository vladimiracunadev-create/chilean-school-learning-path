# de Actitud MA1M OAA C — Demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-10653}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-10654}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-10655}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-10656}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar interés, esfuerzo, perseverancia y rigor en la resolución de problemas y la búsqueda de…» y demostrarlo mediante solución representada, explicada y comprobada.
