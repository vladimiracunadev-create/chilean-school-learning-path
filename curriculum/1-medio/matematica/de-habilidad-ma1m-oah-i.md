# de Habilidad MA1M OAH i — Seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-10615}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un intervalo de valores». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-10616}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-10617}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-10618}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «seleccionar modelos e identificar cuándo dos variables dependen linealmente o afinmente en un…» y demostrarlo mediante solución representada, explicada y comprobada.
