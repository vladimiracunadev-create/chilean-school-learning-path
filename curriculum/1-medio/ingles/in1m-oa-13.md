# IN1M OA 13 — Escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…
...
> Escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva y novedosa para reforzar el mensaje en textos variados, acerca de temas como: Experiencias personales. Contenidos interdisciplinarios. Aspectos de interés global. Cultura de otros países. Textos leídos.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10234}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva y novedosa para reforzar el mensaje en textos variados, acerca de temas como: Experiencias personales. Contenidos interdisciplinarios. Aspectos de interés global. Cultura de otros países. Textos leídos». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10235}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10236}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10237}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10238}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma atractiva…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/1-medio/in1m-oa-13)
