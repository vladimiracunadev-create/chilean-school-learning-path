# EN1M OA 11 — Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…
...
> Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos, correos electrónicos, folletos, noticias, descripciones, biografías, instrucciones, artículos, resúmenes y diario personal (journal), usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales. contenidos interdisciplinarios. aspectos de interés global. cultura de otros países. textos leídos.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10325}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos, correos electrónicos, folletos, noticias, descripciones, biografías, instrucciones, artículos, resúmenes y diario personal (journal), usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales. contenidos interdisciplinarios. aspectos de interés global. cultura de otros países. textos leídos». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10326}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10327}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10328}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10329}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles-propuesta/1-medio/en1m-oa-11)
