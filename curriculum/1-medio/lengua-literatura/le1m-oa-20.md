# LE1M OA 20 — Resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° medio | Lengua y Literatura | Comunicación oral | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-10456}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-10457}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-10458}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-10459}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «resumir un discurso argumentativo escuchado, explicando y evaluando los argumentos usados por el emisor» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/lengua-literatura/1-medio/le1m-oa-20)
