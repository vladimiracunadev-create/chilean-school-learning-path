# TE1M OA 03 — Evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° medio | Tecnología | Resolución de problemas tecnológicos | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10800}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer mejoras asociadas tanto a los procesos como al producto final». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10801}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10802}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10803}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10804}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «evaluar el servicio desarrollado considerando criterios propios, técnicos y valóricos, y proponer…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/1-medio/te1m-oa-03)
