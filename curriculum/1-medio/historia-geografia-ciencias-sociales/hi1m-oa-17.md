# HI1M OA 17 — Caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-10003}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el crecimiento del ingreso fiscal, de los distintos sectores productivos, y de las inversiones públicas en infraestructura y en educación». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-10004}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-10005}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-10006}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «caracterizar las principales transformaciones generadas por las riquezas del salitre, reconociendo el…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/historia-geografia-ciencias-sociales/1-medio/hi1m-oa-17)
