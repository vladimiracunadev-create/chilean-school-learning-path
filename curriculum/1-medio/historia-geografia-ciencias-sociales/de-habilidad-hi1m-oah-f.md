# de Habilidad HI1M OAH f — Seleccionar fuentes de información, considerando
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10093}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «seleccionar fuentes de información, considerando» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **seleccionar fuentes de información, considerando**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Seleccionar fuentes de información, considerando: La confiabilidad de la fuente (autor, origen o contexto, intención, validez de los datos). La relevancia y valor de la información. El uso de diversas fuentes para obtener información que permita enriquecer y profundizar el análisis». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **seleccionar fuentes de información, considerando**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10094}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «seleccionar fuentes de información, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10095}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «seleccionar fuentes de información, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10096}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «seleccionar fuentes de información, considerando» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10097}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «seleccionar fuentes de información, considerando» y demostrarlo mediante explicación o indagación con evidencia.
