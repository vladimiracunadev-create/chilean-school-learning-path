# LE01 OA 14 — Escribir oraciones completas para transmitir mensajes
...
### Clase 1 de 5: Explorar lo que ya sabemos: escribir oraciones completas para transmitir… {#cl-00651}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Escribir oraciones completas para transmitir mensajes».

**Meta para estudiantes:** Hoy aprenderé a escribir oraciones completas para transmitir mensajes y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Escribir oraciones completas para transmitir mensajes», lee o escribe pensando en voz alta, señala letras, sonidos, espacios o pistas de significado y vuelve al texto para comprobar. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «escribir oraciones completas para transmitir…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «escribir oraciones completas para transmitir…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: escribir oraciones completas para transmitir… {#cl-00652}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Escribir oraciones completas para transmitir mensajes».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: escribir oraciones completas para transmitir… {#cl-00653}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Escribir oraciones completas para transmitir mensajes».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: escribir oraciones completas para transmitir… {#cl-00654}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Escribir oraciones completas para transmitir mensajes».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: escribir oraciones completas para transmitir… {#cl-00655}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Escribir oraciones completas para transmitir mensajes».
