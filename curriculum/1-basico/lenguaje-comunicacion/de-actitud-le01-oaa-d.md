# de Actitud LE01 OAA D — Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Lenguaje y Comunicación | Actitudes | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Explorar lo que ya sabemos: realizar tareas y trabajos de forma rigurosa… {#cl-00729}
**Estado editorial:** Integración transversal en las clases de los OA de contenido.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera adecuada a los propósitos de la asignatura».

**Meta para estudiantes:** Hoy aprenderé a realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera adecuada a los propósitos de la asignatura», lee o escribe pensando en voz alta, señala letras, sonidos, espacios o pistas de significado y vuelve al texto para comprobar. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «realizar tareas y trabajos de forma rigurosa…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «realizar tareas y trabajos de forma rigurosa…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: realizar tareas y trabajos de forma rigurosa… {#cl-00730}
**Estado editorial:** Integración transversal en las clases de los OA de contenido.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera adecuada a los propósitos de la asignatura».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: realizar tareas y trabajos de forma rigurosa… {#cl-00731}
**Estado editorial:** Integración transversal en las clases de los OA de contenido.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera adecuada a los propósitos de la asignatura».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: realizar tareas y trabajos de forma rigurosa… {#cl-00732}
**Estado editorial:** Integración transversal en las clases de los OA de contenido.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Realizar tareas y trabajos de forma rigurosa y perseverante, con el fin de desarrollarlos de manera adecuada a los propósitos de la asignatura».
