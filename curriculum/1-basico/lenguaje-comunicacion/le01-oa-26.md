# LE01 OA 26 — Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para…
...
### Clase 1 de 5: Explorar lo que ya sabemos: recitar con entonación y expresión poemas,… {#cl-00712}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…».

**Meta para estudiantes:** Hoy aprenderé a recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…», lee o escribe pensando en voz alta, señala letras, sonidos, espacios o pistas de significado y vuelve al texto para comprobar. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «recitar con entonación y expresión poemas,…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «recitar con entonación y expresión poemas,…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: recitar con entonación y expresión poemas,… {#cl-00713}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: recitar con entonación y expresión poemas,… {#cl-00714}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: recitar con entonación y expresión poemas,… {#cl-00715}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: recitar con entonación y expresión poemas,… {#cl-00716}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Recitar con entonación y expresión poemas, rimas, canciones, trabalenguas y adivinanzas para fortalecer la confianza en sí mismos, aumentar el vocabulario y desarrollar su capacidad…».
