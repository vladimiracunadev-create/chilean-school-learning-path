# LE01 OA 05 — Leer textos breves en voz alta para adquirir fluidez
...
### Clase 1 de 5: Explorar lo que ya sabemos: leer textos breves en voz alta para adquirir… {#cl-00605}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…».

**Meta para estudiantes:** Hoy aprenderé a leer textos breves en voz alta para adquirir fluidez y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…», lee o escribe pensando en voz alta, señala letras, sonidos, espacios o pistas de significado y vuelve al texto para comprobar. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «leer textos breves en voz alta para adquirir…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «leer textos breves en voz alta para adquirir…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: leer textos breves en voz alta para adquirir… {#cl-00606}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: leer textos breves en voz alta para adquirir… {#cl-00607}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: leer textos breves en voz alta para adquirir… {#cl-00608}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: leer textos breves en voz alta para adquirir… {#cl-00609}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Leer textos breves en voz alta para adquirir fluidez: pronunciando cada palabra con precisión, aunque se autocorrijan en algunas ocasiones respetando el punto seguido y el punto aparte…».
