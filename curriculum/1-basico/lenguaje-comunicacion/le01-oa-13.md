# LE01 OA 13 — Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros
...
### Clase 1 de 4: Explorar lo que ya sabemos: experimentar con la escritura para comunicar… {#cl-00647}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros».

**Meta para estudiantes:** Hoy aprenderé a experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros», lee o escribe pensando en voz alta, señala letras, sonidos, espacios o pistas de significado y vuelve al texto para comprobar. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «experimentar con la escritura para comunicar…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «experimentar con la escritura para comunicar…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: experimentar con la escritura para comunicar… {#cl-00648}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: experimentar con la escritura para comunicar… {#cl-00649}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: experimentar con la escritura para comunicar… {#cl-00650}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Experimentar con la escritura para comunicar hechos, ideas y sentimientos, entre otros».
