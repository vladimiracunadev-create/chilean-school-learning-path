# EN01 OA 08 — Leer y aplicar estrategias para apoyar la comprensión
...
> Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo acompañan; releer o leer a otros en voz alta, dibujar o recontar con ayuda.
...
### Clase 1 de 5: Explorar lo que ya sabemos: leer y aplicar estrategias para apoyar la… {#cl-00389}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…».

**Meta para estudiantes:** Hoy aprenderé a leer y aplicar estrategias para apoyar la comprensión y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «leer y aplicar estrategias para apoyar la…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «leer y aplicar estrategias para apoyar la…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: leer y aplicar estrategias para apoyar la… {#cl-00390}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: leer y aplicar estrategias para apoyar la… {#cl-00391}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: leer y aplicar estrategias para apoyar la… {#cl-00392}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: leer y aplicar estrategias para apoyar la… {#cl-00393}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Leer y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; establecer relaciones con conocimientos previos; relacionar el texto con las imágenes que lo…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-08)
