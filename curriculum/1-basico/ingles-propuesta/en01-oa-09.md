# EN01 OA 09 — Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando…
...
> Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras); dramatizaciones; palabras o frases escritas.
...
### Clase 1 de 5: Explorar lo que ya sabemos: reaccionar a lo leído, estableciendo… {#cl-00394}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…».

**Meta para estudiantes:** Hoy aprenderé a reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «reaccionar a lo leído, estableciendo…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «reaccionar a lo leído, estableciendo…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: reaccionar a lo leído, estableciendo… {#cl-00395}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: reaccionar a lo leído, estableciendo… {#cl-00396}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: reaccionar a lo leído, estableciendo… {#cl-00397}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: reaccionar a lo leído, estableciendo… {#cl-00398}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Reaccionar a lo leído, estableciendo relaciones con experiencias personales y/o expresando preferencias, sentimientos u opiniones por medio de: ilustraciones y representaciones (figuras);…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-09)
