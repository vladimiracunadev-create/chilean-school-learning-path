# EN01 OA 04 — Escuchar textos orales y aplicar estrategias para apoyar la comprensión
...
> Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes; focalizar la atención en palabras clave.
...
### Clase 1 de 5: Explorar lo que ya sabemos: escuchar textos orales y aplicar estrategias… {#cl-00369}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…».

**Meta para estudiantes:** Hoy aprenderé a escuchar textos orales y aplicar estrategias para apoyar la comprensión y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «escuchar textos orales y aplicar estrategias…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «escuchar textos orales y aplicar estrategias…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: escuchar textos orales y aplicar estrategias… {#cl-00370}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: escuchar textos orales y aplicar estrategias… {#cl-00371}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: escuchar textos orales y aplicar estrategias… {#cl-00372}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: escuchar textos orales y aplicar estrategias… {#cl-00373}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Escuchar textos orales y aplicar estrategias para apoyar la comprensión; por ejemplo: hacer predicciones; hacer conexiones con conocimientos previos; relacionar el texto con imágenes;…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-04)
