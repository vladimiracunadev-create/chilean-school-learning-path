...
### Clase 1 de 5: Explorar lo que ya sabemos: leer y demostrar comprensión de textos como… {#cl-00379}
...
**Meta para estudiantes:** Hoy aprenderé a leer y demostrar comprensión de textos como cuentos, rimas, chants, tarjetas de saludo,… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Leer y demostrar comprensión de textos como cuentos, rimas, chants, tarjetas de saludo, instrucciones y textos informativos, identificando: ideas generales del texto; personajes y acciones;…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «leer y demostrar comprensión de textos como…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «leer y demostrar comprensión de textos como…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: leer y demostrar comprensión de textos como… {#cl-00380}
...
### Clase 3 de 5: Practicar juntos y aprender del intento: leer y demostrar comprensión de textos como… {#cl-00381}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Leer y demostrar comprensión de textos como cuentos, rimas, chants, tarjetas de saludo, instrucciones y textos informativos, identificando: ideas generales del texto; personajes y acciones;…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: leer y demostrar comprensión de textos como… {#cl-00382}
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: leer y demostrar comprensión de textos como… {#cl-00383}
