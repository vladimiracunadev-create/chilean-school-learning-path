...
- Recuperación opcional: vuelve a un ejemplo concreto de «reproducir chants, rimas y diálogos muy…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «reproducir chants, rimas y diálogos muy…» y pide predecir, comprobar y revisar.
