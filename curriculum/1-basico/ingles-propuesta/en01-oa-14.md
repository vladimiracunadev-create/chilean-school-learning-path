# EN01 OA 14 — Escribir, sobre la base de imágenes, para
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Inglés (Propuesta) | Expresión escrita | propuesta-mineduc | 5 clases de 90 min |

## Qué se debe aprender
> Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números hasta el veinte; describir ubicación de objetos y acciones que ocurren al momento de hablar.
...
### Clase 1 de 5: Explorar lo que ya sabemos: escribir, sobre la base de imágenes, para {#cl-00418}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…».

**Meta para estudiantes:** Hoy aprenderé a escribir, sobre la base de imágenes, para y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «escribir, sobre la base de imágenes, para», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «escribir, sobre la base de imágenes, para» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: escribir, sobre la base de imágenes, para {#cl-00419}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: escribir, sobre la base de imágenes, para {#cl-00420}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: escribir, sobre la base de imágenes, para {#cl-00421}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: escribir, sobre la base de imágenes, para {#cl-00422}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Escribir, sobre la base de imágenes, para: identificar animales, acciones, objetos y partes de la casa, ocupaciones, lugares, comida; expresar sentimientos; expresar cantidades en números…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-14)
