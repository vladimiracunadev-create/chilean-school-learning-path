# EN01 OA 01 — Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como
...
> Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos.
...
### Clase 1 de 5: Explorar lo que ya sabemos: comprender textos leídos por un adulto o en… {#cl-00354}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos».

**Meta para estudiantes:** Hoy aprenderé a comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «comprender textos leídos por un adulto o en…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comprender textos leídos por un adulto o en…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: comprender textos leídos por un adulto o en… {#cl-00355}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: comprender textos leídos por un adulto o en… {#cl-00356}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: comprender textos leídos por un adulto o en… {#cl-00357}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: comprender textos leídos por un adulto o en… {#cl-00358}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Comprender textos leídos por un adulto o en formato audiovisual, breves y simples, como: rimas y chants; canciones; cuentos; diálogos».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-01)
