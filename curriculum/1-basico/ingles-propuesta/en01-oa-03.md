# EN01 OA 03 — Demostrar comprensión de textos orales
...
> Demostrar comprensión de textos orales: identificando personajes, objetos y animales -la escuela, animales salvajes, partes de la casa y muebles, figuras geométricas, ocupaciones, lugares en la ciudad, comida, celebraciones (Easter)-; siguiendo instrucciones simples; identificando palabras, expresiones de uso muy frecuente y vocabulario aprendido; identificando sonidos propios del inglés que pueden interferir en la comprensión, como /s/-/z/, /w/-/th/.
...
### Clase 1 de 5: Explorar lo que ya sabemos: demostrar comprensión de textos orales {#cl-00364}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Demostrar comprensión de textos orales: identificando personajes, objetos y animales -la escuela, animales salvajes, partes de la casa y muebles, figuras geométricas, ocupaciones, lugares…».

**Meta para estudiantes:** Hoy aprenderé a demostrar comprensión de textos orales y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Demostrar comprensión de textos orales: identificando personajes, objetos y animales -la escuela, animales salvajes, partes de la casa y muebles, figuras geométricas, ocupaciones, lugares…», modela primero el significado con imagen, gesto y entonación; luego repite la expresión en un contexto distinto sin traducir palabra por palabra. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «demostrar comprensión de textos orales», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «demostrar comprensión de textos orales» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: demostrar comprensión de textos orales {#cl-00365}
...
### Clase 3 de 5: Practicar juntos y aprender del intento: demostrar comprensión de textos orales {#cl-00366}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Demostrar comprensión de textos orales: identificando personajes, objetos y animales -la escuela, animales salvajes, partes de la casa y muebles, figuras geométricas, ocupaciones, lugares…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: demostrar comprensión de textos orales {#cl-00367}
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: demostrar comprensión de textos orales {#cl-00368}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/1-basico/en01-oa-03)
