...
### Clase 1 de 5: Conectar y diagnosticar {#cl-01006}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 3 de 5: Practicar con apoyo {#cl-01008}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-01009}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-01010}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar ideas por medio de imágenes, guiados por el docente» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
