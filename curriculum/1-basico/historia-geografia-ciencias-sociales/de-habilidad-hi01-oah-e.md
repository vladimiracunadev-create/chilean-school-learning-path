# de Habilidad HI01 OAH e — Obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Historia, Geografía y Ciencias Sociales | Análisis y trabajo con fuentes de información | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Explorar lo que ya sabemos: obtener información explícita sobre su… {#cl-00306}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas (narraciones, fotografías, medios audiovisuales), mediante preguntas dirigidas».

**Meta para estudiantes:** Hoy aprenderé a obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas… y mostraré cómo lo hice.
...
- Recuperación opcional: vuelve a un ejemplo concreto de «obtener información explícita sobre su…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «obtener información explícita sobre su…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: obtener información explícita sobre su… {#cl-00307}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas (narraciones, fotografías, medios audiovisuales), mediante preguntas dirigidas».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: obtener información explícita sobre su… {#cl-00308}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas (narraciones, fotografías, medios audiovisuales), mediante preguntas dirigidas».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: obtener información explícita sobre su… {#cl-00309}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Obtener información explícita sobre su entorno a partir de fuentes orales y gráficas dadas (narraciones, fotografías, medios audiovisuales), mediante preguntas dirigidas».
