# HI01 OA 13 — Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad)…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Historia, Geografía y Ciencias Sociales | Formación ciudadana | formacion-general-comun | 5 clases de 90 min |

## Qué se debe aprender
> Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con cortesía a los demás, etc.) empatía (ejemplos: ayudar a los demás cuando sea necesario, no discriminar a otros por su aspecto o costumbres, etc.) responsabilidad (ejemplos: asumir encargos en su casa y su sala de clases, cuidar sus pertenencias y las de los demás, cuidar los espacios comunes, etc).
...
### Clase 1 de 5: Explorar lo que ya sabemos: mostrar actitudes y realizar acciones… {#cl-00277}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…».

**Meta para estudiantes:** Hoy aprenderé a mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…», identifica qué muestra la fuente, ordena o ubica la información y distingue el dato visible de una inferencia. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «mostrar actitudes y realizar acciones…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «mostrar actitudes y realizar acciones…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: mostrar actitudes y realizar acciones… {#cl-00278}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: mostrar actitudes y realizar acciones… {#cl-00279}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…».
...
**Tarea breve y flexible:** Tarea breve y flexible (10 minutos): Repite un caso breve usando la pista aprendida y marca cuándo pudiste retirarla. Conversa con una persona adulta sobre una rutina, lugar u objeto cercano y registra un dato sin incluir información privada. Puede resolverse oralmente, con dibujo u objetos; no requiere internet, impresión ni compra de materiales.
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: mostrar actitudes y realizar acciones… {#cl-00280}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: mostrar actitudes y realizar acciones… {#cl-00281}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Mostrar actitudes y realizar acciones concretas en su entorno cercano (familia, escuela y comunidad) que reflejen: respeto al otro (ejemplos: escuchar atentamente al otro, tratar con…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/historia-geografia-ciencias-sociales/1-basico/hi01-oa-13)
