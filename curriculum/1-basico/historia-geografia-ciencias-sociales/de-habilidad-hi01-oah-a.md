# de Habilidad HI01 OAH a — Secuenciar cronológicamente eventos de su familia
...
| Modelado | 20 min | Para trabajar «Secuenciar cronológicamente eventos de su familia», identifica qué muestra la fuente, ordena o ubica la información y distingue el dato visible de una inferencia. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «secuenciar cronológicamente eventos de su…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «secuenciar cronológicamente eventos de su…» y pide predecir, comprobar y revisar.
