# de Habilidad HI01 OAH g — Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Historia, Geografía y Ciencias Sociales | Comunicación | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud
...
### Clase 1 de 4: Explorar lo que ya sabemos: comunicar oralmente temas de su interés,… {#cl-00314}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud».

**Meta para estudiantes:** Hoy aprenderé a comunicar oralmente temas de su interés, experiencias personales o información sobre sí… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud», identifica qué muestra la fuente, ordena o ubica la información y distingue el dato visible de una inferencia. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «comunicar oralmente temas de su interés,…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comunicar oralmente temas de su interés,…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: comunicar oralmente temas de su interés,… {#cl-00315}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: comunicar oralmente temas de su interés,… {#cl-00316}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: comunicar oralmente temas de su interés,… {#cl-00317}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Comunicar oralmente temas de su interés, experiencias personales o información sobre sí mismos, de manera clara y coherente. Actitud».
