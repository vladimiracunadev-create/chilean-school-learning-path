...
### Clase 1 de 4: Conectar y diagnosticar {#cl-00302}
...
| Explicación | 20 min | Modela cómo abordar «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 4: Comprender y modelar {#cl-00303}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-00304}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-00305}
