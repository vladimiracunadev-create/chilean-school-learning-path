# de Habilidad HI01 OAH d — Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Historia, Geografía y Ciencias Sociales | Pensamiento temporal y espacial | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Explorar lo que ya sabemos: orientarse en el espacio, utilizando… {#cl-00302}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)».

**Meta para estudiantes:** Hoy aprenderé a orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda,… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)», identifica qué muestra la fuente, ordena o ubica la información y distingue el dato visible de una inferencia. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «orientarse en el espacio, utilizando…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «orientarse en el espacio, utilizando…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: orientarse en el espacio, utilizando… {#cl-00303}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: orientarse en el espacio, utilizando… {#cl-00304}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: orientarse en el espacio, utilizando… {#cl-00305}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Orientarse en el espacio, utilizando categorías de ubicación relativa (derecha, izquierda, lejos, cerca, delante, detrás, arriba, abajo, adentro, afuera)».
