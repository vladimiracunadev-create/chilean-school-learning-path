# de Actitud CN01 OAA C — Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y…
...
### Clase 1 de 4: Explorar lo que ya sabemos: reconocer la importancia del entorno natural… {#cl-00126}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y protección del ambiente».

**Meta para estudiantes:** Hoy aprenderé a reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y protección del ambiente», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «reconocer la importancia del entorno natural…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «reconocer la importancia del entorno natural…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: reconocer la importancia del entorno natural… {#cl-00127}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y protección del ambiente».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: reconocer la importancia del entorno natural… {#cl-00128}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y protección del ambiente».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: reconocer la importancia del entorno natural… {#cl-00129}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Reconocer la importancia del entorno natural y sus recursos, desarrollando conductas de cuidado y protección del ambiente».
