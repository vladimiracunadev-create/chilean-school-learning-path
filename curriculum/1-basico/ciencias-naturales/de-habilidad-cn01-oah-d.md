# de Habilidad CN01 OAH d — Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Ciencias Naturales | Analizar la evidencia y comunicar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud
...
### Clase 1 de 4: Explorar lo que ya sabemos: comunicar y comparar con otros sus ideas,… {#cl-00114}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud».

**Meta para estudiantes:** Hoy aprenderé a comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y… y mostraré cómo lo hice.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Sitúa un objeto, ser vivo, fenómeno o fotografía cercana que pueda observarse con seguridad. Presenta dos ejemplos contrastados y pide que cada estudiante elija, muestre o explique qué nota. Recoge una respuesta de todo el curso y conserva dos ejemplos para compararlos al cierre. |
| Modelado | 20 min | Para trabajar «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
| Práctica guiada | 25 min | Observan, clasifican o comparan casos y justifican cada decisión con una característica verificable. Usa la pregunta «¿qué viste, escuchaste, hiciste o pensaste que te permite decirlo?» y retroalimenta el criterio, no la rapidez. |
| Desempeño individual | 25 min | Cada estudiante completa un registro con dibujo rotulado, observación, explicación y una pregunta nueva. La evidencia debe ser individual aunque materiales y conversación puedan compartirse. |
...
**Materiales y preparación:** Objetos o fotografías seguras, lupa opcional, fichas de registro y lápices; observar sin dañar ni extraer seres vivos

**Apoyo en el mismo OA:** Usa tabla «observo/pienso», banco visual de vocabulario y explicación oral señalando el registro

**Profundización:** Predice qué cambiaría en otro caso y señala qué observación permitiría comprobarlo
...
**Criterios de éxito:** registra evidencia observable; usa vocabulario científico del OA; explica la relación sin confundir opinión con dato.
...
- Recuperación opcional: vuelve a un ejemplo concreto de «comunicar y comparar con otros sus ideas,…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comunicar y comparar con otros sus ideas,…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: comunicar y comparar con otros sus ideas,… {#cl-00115}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud».

**Meta para estudiantes:** Hoy aprenderé a comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y… y mostraré cómo lo hice.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Sitúa un objeto, ser vivo, fenómeno o fotografía cercana que pueda observarse con seguridad. Resuelve un ejemplo paso a paso, nombra cada decisión y contrasta un caso que no cumple el criterio. Recoge una respuesta de todo el curso y conserva dos ejemplos para compararlos al cierre. |
| Modelado | 20 min | Para trabajar «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
| Práctica guiada | 25 min | Observan, clasifican o comparan casos y justifican cada decisión con una característica verificable. Usa la pregunta «¿qué viste, escuchaste, hiciste o pensaste que te permite decirlo?» y retroalimenta el criterio, no la rapidez. |
| Desempeño individual | 25 min | Cada estudiante completa un registro con dibujo rotulado, observación, explicación y una pregunta nueva. La evidencia debe ser individual aunque materiales y conversación puedan compartirse. |
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: comunicar y comparar con otros sus ideas,… {#cl-00116}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud».

**Meta para estudiantes:** Hoy aprenderé a comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y… y mostraré cómo lo hice.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Sitúa un objeto, ser vivo, fenómeno o fotografía cercana que pueda observarse con seguridad. Plantea una situación distinta a la ensayada, recuerda los criterios y observa antes de intervenir. Recoge una respuesta de todo el curso y conserva dos ejemplos para compararlos al cierre. |
| Modelado | 20 min | Para trabajar «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
| Práctica guiada | 25 min | Observan, clasifican o comparan casos y justifican cada decisión con una característica verificable. Usa la pregunta «¿qué viste, escuchaste, hiciste o pensaste que te permite decirlo?» y retroalimenta el criterio, no la rapidez. |
| Desempeño individual | 25 min | Cada estudiante completa un registro con dibujo rotulado, observación, explicación y una pregunta nueva. La evidencia debe ser individual aunque materiales y conversación puedan compartirse. |
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: comunicar y comparar con otros sus ideas,… {#cl-00117}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud».

**Meta para estudiantes:** Hoy aprenderé a comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y… y mostraré cómo lo hice.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Sitúa un objeto, ser vivo, fenómeno o fotografía cercana que pueda observarse con seguridad. Analiza una respuesta ficticia, localiza una fortaleza y un error, y muestra cómo se mejora sin reemplazar el trabajo del estudiante. Recoge una respuesta de todo el curso y conserva dos ejemplos para compararlos al cierre. |
| Modelado | 20 min | Para trabajar «Comunicar y comparar con otros sus ideas, observaciones y experiencias de forma oral y escrita, y por medio de juegos de roles y dibujos, entre otros. Actitud», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
| Práctica guiada | 25 min | Observan, clasifican o comparan casos y justifican cada decisión con una característica verificable. Usa la pregunta «¿qué viste, escuchaste, hiciste o pensaste que te permite decirlo?» y retroalimenta el criterio, no la rapidez. |
| Desempeño individual | 25 min | Cada estudiante completa un registro con dibujo rotulado, observación, explicación y una pregunta nueva. La evidencia debe ser individual aunque materiales y conversación puedan compartirse. |
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/1-basico)
- [Asignatura y nivel](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/1-basico)
- Snapshot: 2026-09-24
