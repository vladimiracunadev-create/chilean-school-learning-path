# de Actitud CN01 OAA D — Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Ciencias Naturales | Actitudes | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Explorar lo que ya sabemos: asumir responsabilidades e interactuar en… {#cl-00130}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo, aportando y enriqueciendo el trabajo común».

**Meta para estudiantes:** Hoy aprenderé a asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo, aportando y enriqueciendo el trabajo común», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «asumir responsabilidades e interactuar en…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «asumir responsabilidades e interactuar en…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: asumir responsabilidades e interactuar en… {#cl-00131}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo, aportando y enriqueciendo el trabajo común».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: asumir responsabilidades e interactuar en… {#cl-00132}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo, aportando y enriqueciendo el trabajo común».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: asumir responsabilidades e interactuar en… {#cl-00133}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Asumir responsabilidades e interactuar en forma colaborativa y flexible en los trabajos en equipo, aportando y enriqueciendo el trabajo común».
