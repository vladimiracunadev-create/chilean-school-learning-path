# de Habilidad CN01 OAH a — Explorar y observar la naturaleza, usando los sentidos apropiadamente durante investigaciones…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Ciencias Naturales | Observar y preguntar | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Explorar lo que ya sabemos: explorar y observar la naturaleza, usando los… {#cl-00102}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Explorar y observar la naturaleza, usando los sentidos apropiadamente durante investigaciones experimentales guiadas».

**Meta para estudiantes:** Hoy aprenderé a explorar y observar la naturaleza, usando los sentidos apropiadamente durante… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Explorar y observar la naturaleza, usando los sentidos apropiadamente durante investigaciones experimentales guiadas», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
