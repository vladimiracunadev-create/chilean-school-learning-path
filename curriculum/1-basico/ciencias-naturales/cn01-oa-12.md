# CN01 OA 12 — Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el…
...
### Clase 1 de 4: Explorar lo que ya sabemos: describir y comunicar los cambios del ciclo… {#cl-00098}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el ambiente».

**Meta para estudiantes:** Hoy aprenderé a describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el ambiente», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «describir y comunicar los cambios del ciclo…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «describir y comunicar los cambios del ciclo…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: describir y comunicar los cambios del ciclo… {#cl-00099}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el ambiente».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: describir y comunicar los cambios del ciclo… {#cl-00100}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el ambiente».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: describir y comunicar los cambios del ciclo… {#cl-00101}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Describir y comunicar los cambios del ciclo de las estaciones y sus efectos en los seres vivos y el ambiente».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/1-basico/cn01-oa-12)
