# CN01 OA 04 — Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma,…
...
### Clase 1 de 4: Explorar lo que ya sabemos: observar y clasificar semillas, frutos,… {#cl-00065}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma, textura y color, entre otros».

**Meta para estudiantes:** Hoy aprenderé a observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño,… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma, textura y color, entre otros», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «observar y clasificar semillas, frutos,…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «observar y clasificar semillas, frutos,…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: observar y clasificar semillas, frutos,… {#cl-00066}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma, textura y color, entre otros».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: observar y clasificar semillas, frutos,… {#cl-00067}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma, textura y color, entre otros».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: observar y clasificar semillas, frutos,… {#cl-00068}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Observar y clasificar semillas, frutos, flores y tallos a partir de criterios como tamaño, forma, textura y color, entre otros».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/1-basico/cn01-oa-04)
