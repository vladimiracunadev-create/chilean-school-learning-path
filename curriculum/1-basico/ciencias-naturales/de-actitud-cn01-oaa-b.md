# de Actitud CN01 OAA B — Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura
...
### Clase 1 de 4: Explorar lo que ya sabemos: manifestar un estilo de trabajo riguroso y… {#cl-00122}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura».

**Meta para estudiantes:** Hoy aprenderé a manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura», separa «veo o mido» de «pienso que», registra un detalle y explica qué evidencia permite sostener la idea. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «manifestar un estilo de trabajo riguroso y…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «manifestar un estilo de trabajo riguroso y…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: manifestar un estilo de trabajo riguroso y… {#cl-00123}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: manifestar un estilo de trabajo riguroso y… {#cl-00124}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: manifestar un estilo de trabajo riguroso y… {#cl-00125}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Manifestar un estilo de trabajo riguroso y perseverante para lograr los aprendizajes de la asignatura».
