# LC01 OA 16 — Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Lengua y Cultura de los Pueblos Originarios Ancestrales | Patrimonio, tecnologías, técnicas, ciencias y artes ancestrales de los pueblos originarios | segun-contexto-y-normativa | 4 clases de 90 min |

## Qué se debe aprender
> Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros).
...
### Clase 1 de 4: Explorar lo que ya sabemos: comprender la relación entre el ser humano,… {#cl-00547}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros)».

**Meta para estudiantes:** Hoy aprenderé a comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros)», presenta la fuente y su procedencia, escucha o lee la expresión con respeto y explica su sentido cultural sin tratar a los pueblos como una realidad única. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «comprender la relación entre el ser humano,…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comprender la relación entre el ser humano,…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: comprender la relación entre el ser humano,… {#cl-00548}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros)».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: comprender la relación entre el ser humano,… {#cl-00549}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros)».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: comprender la relación entre el ser humano,… {#cl-00550}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Comprender la relación entre el ser humano, la naturaleza y el cosmos, considerando la perspectiva indígena de la ciencia (astros, medicina ancestral, navegación, entre otros)».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/1-basico/lc01-oa-16)
