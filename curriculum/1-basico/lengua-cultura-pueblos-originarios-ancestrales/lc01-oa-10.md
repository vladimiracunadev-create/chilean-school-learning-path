# LC01 OA 10 — Comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…
...
### Clase 1 de 4: Explorar lo que ya sabemos: comprender la relación del ser humano con la… {#cl-00522}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para los pueblos indígenas».

**Meta para estudiantes:** Hoy aprenderé a comprender la relación del ser humano con la naturaleza, considerando la importancia que… y mostraré cómo lo hice.
...
- Recuperación opcional: vuelve a un ejemplo concreto de «comprender la relación del ser humano con la…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comprender la relación del ser humano con la…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: comprender la relación del ser humano con la… {#cl-00523}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para los pueblos indígenas».
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: comprender la relación del ser humano con la… {#cl-00524}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para los pueblos indígenas».
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: comprender la relación del ser humano con la… {#cl-00525}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para los pueblos indígenas».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/1-basico/lc01-oa-10)
