...
### Clase 1 de 4: Conectar y diagnosticar {#cl-00522}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-00523}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-00524}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-00525}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «comprender la relación del ser humano con la naturaleza, considerando la importancia que tiene para…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
