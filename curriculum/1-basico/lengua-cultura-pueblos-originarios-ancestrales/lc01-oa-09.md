...
- Recuperación opcional: vuelve a un ejemplo concreto de «comprender que los pueblos indígenas poseen…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «comprender que los pueblos indígenas poseen…» y pide predecir, comprobar y revisar.
