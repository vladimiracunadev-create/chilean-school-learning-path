# LC01 OA 13 — Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Lengua y Cultura de los Pueblos Originarios Ancestrales | Cosmovisión de los pueblos originarios | segun-contexto-y-normativa | 5 clases de 90 min |
...
### Clase 1 de 5: Explorar lo que ya sabemos: identificar los valores y principios… {#cl-00534}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural».

**Meta para estudiantes:** Hoy aprenderé a identificar los valores y principios personales y familiares de acuerdo a cada contexto… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural», presenta la fuente y su procedencia, escucha o lee la expresión con respeto y explica su sentido cultural sin tratar a los pueblos como una realidad única. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «identificar los valores y principios…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «identificar los valores y principios…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: identificar los valores y principios… {#cl-00535}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: identificar los valores y principios… {#cl-00536}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: identificar los valores y principios… {#cl-00537}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: identificar los valores y principios… {#cl-00538}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Identificar los valores y principios personales y familiares de acuerdo a cada contexto cultural».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/1-basico/lc01-oa-13)
