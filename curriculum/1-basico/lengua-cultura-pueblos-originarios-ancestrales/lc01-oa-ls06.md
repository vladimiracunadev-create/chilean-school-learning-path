...
### Clase 1 de 4: Explorar lo que ya sabemos: utilizar recursos tecnológicos disponibles… {#cl-00518}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.

**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para conocer sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de culturas…».

**Meta para estudiantes:** Hoy aprenderé a utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Utilizar recursos tecnológicos disponibles (TIC) para conocer sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de culturas…», presenta la fuente y su procedencia, escucha o lee la expresión con respeto y explica su sentido cultural sin tratar a los pueblos como una realidad única. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
### Clase 2 de 4: Mirar cómo se hace y explicar por qué: utilizar recursos tecnológicos disponibles… {#cl-00519}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.
...
### Clase 3 de 4: Resolver un desafío con mis propias decisiones: utilizar recursos tecnológicos disponibles… {#cl-00520}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.
...
### Clase 4 de 4: Mostrar lo aprendido, revisar y mejorar: utilizar recursos tecnológicos disponibles… {#cl-00521}
**Estado editorial:** Borrador estructurado pendiente de desarrollo específico.
