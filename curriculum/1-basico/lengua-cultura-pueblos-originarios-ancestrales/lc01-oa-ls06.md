# LC01 OA LS06 — Utilizar recursos tecnológicos disponibles (TIC) para conocer sonidos propios de la lengua y símbolos…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-00518}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-00519}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-00520}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-00521}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «utilizar recursos tecnológicos disponibles (tic) para conocer sonidos propios de la lengua y símbolos…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/1-basico/lc01-oa-ls06)
