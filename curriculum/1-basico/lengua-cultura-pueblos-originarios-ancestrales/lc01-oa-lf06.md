# LC01 OA LF06 — Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 1° básico | Lengua y Cultura de los Pueblos Originarios Ancestrales | Contexto de fortalecimiento y desarrollo de la lengua | segun-contexto-y-normativa | 5 clases de 90 min |

## Qué se debe aprender
> Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de culturas originarias afines.
...
### Clase 1 de 5: Explorar lo que ya sabemos: utilizar recursos tecnológicos disponibles… {#cl-00463}
**Propósito docente:** Abrir el aprendizaje desde una experiencia comprensible y recoger evidencia inicial sin calificarla, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…».

**Meta para estudiantes:** Hoy aprenderé a utilizar recursos tecnológicos disponibles (tic) para escuchar y reproducir sonidos propios… y mostraré cómo lo hice.
...
| Modelado | 20 min | Para trabajar «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…», presenta la fuente y su procedencia, escucha o lee la expresión con respeto y explica su sentido cultural sin tratar a los pueblos como una realidad única. Formula una pregunta auténtica y deja cinco segundos de espera antes de aceptar respuestas. |
...
- Recuperación opcional: vuelve a un ejemplo concreto de «utilizar recursos tecnológicos disponibles…», ofrece una sola pista y retírala cuando el estudiante explique la decisión.
- Profundización opcional: cambia una condición del desafío sobre «utilizar recursos tecnológicos disponibles…» y pide predecir, comprobar y revisar.
...
### Clase 2 de 5: Mirar cómo se hace y explicar por qué: utilizar recursos tecnológicos disponibles… {#cl-00464}
**Propósito docente:** Hacer visible el procedimiento o criterio disciplinar mediante una demostración breve y pensada en voz alta, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…».
...
### Clase 3 de 5: Practicar juntos y aprender del intento: utilizar recursos tecnológicos disponibles… {#cl-00465}
**Propósito docente:** Acompañar el primer desempeño completo con preguntas y retroalimentación inmediata, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…».
...
### Clase 4 de 5: Resolver un desafío con mis propias decisiones: utilizar recursos tecnológicos disponibles… {#cl-00466}
**Propósito docente:** Comprobar que cada estudiante puede usar el aprendizaje en una situación nueva sin copiar el ejemplo, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…».
...
### Clase 5 de 5: Mostrar lo aprendido, revisar y mejorar: utilizar recursos tecnológicos disponibles… {#cl-00467}
**Propósito docente:** Integrar el aprendizaje, ofrecer retroalimentación útil y decidir el paso siguiente con evidencia individual, centrado en «Utilizar recursos tecnológicos disponibles (TIC) para escuchar y reproducir sonidos propios de la lengua y símbolos de la escritura ancestral, según el pueblo indígena que corresponda o de…».
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/1-basico/lc01-oa-lf06)
