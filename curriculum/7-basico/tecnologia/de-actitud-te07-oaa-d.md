# de Actitud TE07 OAA D — Trabajar colaborativamente. Unidad de Currículum y Evaluación Ministerio de Educación Teléfono
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Tecnología | Actitudes | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Trabajar colaborativamente. Unidad de Currículum y Evaluación Ministerio de Educación Teléfono: +56 2 24066000
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08423}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Trabajar colaborativamente. Unidad de Currículum y Evaluación Ministerio de Educación Teléfono: +56 2 24066000». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08424}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08425}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08426}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente. unidad de currículum y evaluación ministerio de educación teléfono» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/7-basico)
- [Asignatura y nivel](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/7-basico)
- Snapshot: 2026-09-24
