# TE07 OA 04 — Comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Tecnología | Resolución de problemas tecnológicos | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación, adaptación o mejora de objetos o entornos, utilizando herramientas TIC, considerando el objetivo, la audiencia y aspectos éticos.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08399}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación, adaptación o mejora de objetos o entornos, utilizando herramientas TIC, considerando el objetivo, la audiencia y aspectos éticos». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08400}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08401}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08402}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «comunicar el diseño, la planificación u otros procesos de la resolución de necesidades de reparación,…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/7-basico/te07-oa-04)
