# IN07 OA 01 — Demostrar comprensión de ideas generales e información explícita en textos orales adaptados y…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07632}
...
| Explicación | 20 min | Modela cómo abordar «Demostrar comprensión de ideas generales e información explícita en textos orales adaptados y auténticos simples, literarios y no literarios, en diversos formatos audiovisuales (como exposiciones orales, conversaciones, descripciones, instrucciones, procedimientos, narraciones, rimas y juegos de palabras, canciones), acerca de temas variados (experiencias personales, temas de otras asignaturas, del contexto inmediato, de actualidad e interés global o de otras culturas) y que contienen las funciones del año 1 . (1) Las funciones del idioma correspondientes a cada año se encuentran descritas detalladamente en el OA 8 de comunicación oral y en el OA 16 de expresión escrita». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07633}
...
### Clase 3 de 5: Practicar con apoyo {#cl-07634}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07635}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07636}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/7-basico/in07-oa-01)
