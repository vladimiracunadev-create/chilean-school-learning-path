# MA07 OA 07 — Reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08130}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma ax + by + cz ( a,b,c ϵ Z)». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08131}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08132}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08133}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «reducir expresiones algebraicas, reuniendo términos semejantes para obtener expresiones de la forma…» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/7-basico/ma07-oa-07)
