# MA07 OA 18 — Explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Matemática | Probabilidad y estadística | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-08179}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con software educativo: Estimándolas de manera intuitiva. Utilizando frecuencias relativas. Relacionándolas con razones, fracciones o porcentaje». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-08180}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-08181}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-08182}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «explicar las probabilidades de eventos obtenidos por medio de experimentos de manera manual y/o con…» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/7-basico/ma07-oa-18)
