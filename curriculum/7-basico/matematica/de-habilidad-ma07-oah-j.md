# de Habilidad MA07 OAH j — Evaluar la pertinencia de modelos
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08226}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «evaluar la pertinencia de modelos» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **evaluar la pertinencia de modelos**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Evaluar la pertinencia de modelos: En relación al problema presentado. Considerando sus limitaciones». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **evaluar la pertinencia de modelos**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08227}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «evaluar la pertinencia de modelos» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-08228}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «evaluar la pertinencia de modelos» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08229}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «evaluar la pertinencia de modelos» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08230}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «evaluar la pertinencia de modelos» y demostrarlo mediante solución representada, explicada y comprobada.
