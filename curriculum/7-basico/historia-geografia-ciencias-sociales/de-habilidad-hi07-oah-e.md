# de Habilidad HI07 OAH e — Seleccionar fuentes de información, considerando
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Historia, Geografía y Ciencias Sociales | Análisis y trabajo con fuentes de información | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07560}
...
| Explicación | 20 min | Modela cómo abordar «Seleccionar fuentes de información, considerando: La confiabilidad de la fuente (autor, origen o contexto, intención). La relación con el tema. El uso de diversas fuentes y los distintos tipos de información que entregan». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07561}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07562}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07563}
