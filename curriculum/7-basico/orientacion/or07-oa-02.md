# OR07 OA 02 — Analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Orientación | Crecimiento personal | formacion-general-comun | 6 clases de 90 min |
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-08340}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo personal la integración de las distintas dimensiones de la sexualidad, el cuidado del cuerpo y la intimidad, discriminando formas de relacionarse en un marco de respeto y el uso de fuentes de información apropiadas para su desarrollo personal». Hace visible el uso de bienestar, emoción, decisión, vínculo, límite, responsabilidad y red de apoyo y contrasta un ejemplo logrado con el error: forzar exposición personal; confundir consejo con decisión responsable. |
...
| Desempeño individual | 25 min | Cada estudiante produce reflexión o decisión personal fundada en un caso seguro sobre **analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-08341}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 3 de 6: Practicar con apoyo {#cl-08342}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-08343}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-08344}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-08345}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «analizar, considerando sus experiencias e inquietudes, la importancia que tiene para el desarrollo…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/orientacion/7-basico/or07-oa-02)
