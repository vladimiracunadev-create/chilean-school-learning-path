# MU07 OA 04 — Interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-08281}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de registro y transmisión». Hace visible el uso de pulso, ritmo, altura, timbre, intensidad, forma, interpretación y escucha y contrasta un ejemplo logrado con el error: confundir pulso con ritmo; describir solo gustos sin referirse a lo escuchado. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación, creación o apreciación musical con criterios audibles sobre **interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-08282}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 3 de 5: Practicar con apoyo {#cl-08283}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-08284}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-08285}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «interpretar a una y más voces repertorio diverso, incorporando como apoyo el uso de medios de…» y demostrarlo mediante interpretación, creación o apreciación musical con criterios audibles.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/musica/7-basico/mu07-oa-04)
