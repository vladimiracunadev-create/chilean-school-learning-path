# de Actitud EN07 OAA A — Manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07862}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma, valorando a la vez los logros de los demás». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07863}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07864}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07865}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «manifestar una actitud positiva frente a sí mismo y sus capacidades para aprender y usar el idioma,…» y demostrarlo mediante desempeño comunicativo comprensible.
