# EN07 OA 11 — Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos breves como…
...
> Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos breves como rimas, tiras cómicas, cuentos, correos electrónicos, descripciones, folletos, noticias, usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales contenidos interdisciplinarios problemas globales culturas de otros países textos leídos.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07783}
...
| Explicación | 20 min | Modela cómo abordar «Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos breves como rimas, tiras cómicas, cuentos, correos electrónicos, descripciones, folletos, noticias, usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales contenidos interdisciplinarios problemas globales culturas de otros países textos leídos». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07784}
...
### Clase 3 de 5: Practicar con apoyo {#cl-07785}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07786}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07787}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles-propuesta/7-basico/en07-oa-11)
