# de Habilidad EN07 OAH h — Expresión escrita utilizando las etapas del proceso de escritura para generar textos como…
...
> Expresión escrita utilizando las etapas del proceso de escritura para generar textos como infografías, posters, folletos, etc.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07826}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «expresión escrita utilizando las etapas del proceso de escritura para generar textos como…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **expresión escrita utilizando las etapas del proceso de escritura para generar textos como…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Expresión escrita utilizando las etapas del proceso de escritura para generar textos como infografías, posters, folletos, etc». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **expresión escrita utilizando las etapas del proceso de escritura para generar textos como…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07827}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «expresión escrita utilizando las etapas del proceso de escritura para generar textos como…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07828}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «expresión escrita utilizando las etapas del proceso de escritura para generar textos como…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07829}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «expresión escrita utilizando las etapas del proceso de escritura para generar textos como…» y demostrarlo mediante desempeño comunicativo comprensible.
