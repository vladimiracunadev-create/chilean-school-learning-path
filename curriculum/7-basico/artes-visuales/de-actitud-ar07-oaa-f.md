# de Actitud AR07 OAA F — Compartir trabajos y proyectos visuales con su comunidad o en otros círculos
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07201}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «compartir trabajos y proyectos visuales con su comunidad o en otros círculos» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **compartir trabajos y proyectos visuales con su comunidad o en otros círculos**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Compartir trabajos y proyectos visuales con su comunidad o en otros círculos». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **compartir trabajos y proyectos visuales con su comunidad o en otros círculos**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07202}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «compartir trabajos y proyectos visuales con su comunidad o en otros círculos» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07203}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «compartir trabajos y proyectos visuales con su comunidad o en otros círculos» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07204}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «compartir trabajos y proyectos visuales con su comunidad o en otros círculos» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
