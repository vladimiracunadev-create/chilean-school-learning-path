# AR07 OA 01 — Crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07152}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la observación de manifestaciones estéticas referidas a diversidad cultural, género e íconos sociales, patrimoniales y contemporáneas». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07153}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 5: Practicar con apoyo {#cl-07154}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07155}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07156}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear trabajos visuales basados en las percepciones, sentimientos e ideas generadas a partir de la…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/artes-visuales/7-basico/ar07-oa-01)
