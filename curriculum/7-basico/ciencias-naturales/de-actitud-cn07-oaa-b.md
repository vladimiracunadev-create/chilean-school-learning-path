# de Actitud CN07 OAA B — Esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-07347}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de un trabajo riguroso, y que los datos empíricamente confiables se obtienen si se trabaja con precisión y orden». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-07348}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-07349}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-07350}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «esforzarse y perseverar en el trabajo personal entendiendo que los logros se obtienen solo después de…» y demostrarlo mediante explicación o indagación con evidencia.
