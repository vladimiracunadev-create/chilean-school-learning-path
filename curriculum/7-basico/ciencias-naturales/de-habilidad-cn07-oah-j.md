# de Habilidad CN07 OAH j — Examinar los resultados de una investigación científica para plantear inferencias y conclusiones
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 7° básico | Ciencias Naturales | Procesar y analizar la evidencia | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-07324}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «examinar los resultados de una investigación científica para plantear inferencias y conclusiones» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **examinar los resultados de una investigación científica para plantear inferencias y conclusiones**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Examinar los resultados de una investigación científica para plantear inferencias y conclusiones: Determinando relaciones, tendencias y patrones de la variable en estudio. Usando expresiones y operaciones matemáticas cuando sea pertinente, por ejemplo: proporciones, porcentaje, escalas, unidades, notación científica, frecuencias y medidas de tendencia central (promedio, mediana y moda)». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **examinar los resultados de una investigación científica para plantear inferencias y conclusiones**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-07325}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «examinar los resultados de una investigación científica para plantear inferencias y conclusiones» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-07326}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «examinar los resultados de una investigación científica para plantear inferencias y conclusiones» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-07327}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «examinar los resultados de una investigación científica para plantear inferencias y conclusiones» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-07328}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «examinar los resultados de una investigación científica para plantear inferencias y conclusiones» y demostrarlo mediante explicación o indagación con evidencia.
