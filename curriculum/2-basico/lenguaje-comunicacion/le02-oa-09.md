# LE02 OA 09 — Asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01671}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el material en favor del uso común». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01672}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01673}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01674}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «asistir habitualmente a la biblioteca para encontrar información y elegir libros, cuidando el…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/2-basico/le02-oa-09)
