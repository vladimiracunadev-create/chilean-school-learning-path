# LE02 OA 16 — Planificar la escritura, generando ideas a partir de
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01703}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «planificar la escritura, generando ideas a partir de» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **planificar la escritura, generando ideas a partir de**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Planificar la escritura, generando ideas a partir de: observación de imágenes conversaciones con sus pares o el docente sobre experiencias personales y otros temas». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **planificar la escritura, generando ideas a partir de**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01704}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «planificar la escritura, generando ideas a partir de» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01705}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «planificar la escritura, generando ideas a partir de» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01706}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «planificar la escritura, generando ideas a partir de» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/2-basico/le02-oa-16)
