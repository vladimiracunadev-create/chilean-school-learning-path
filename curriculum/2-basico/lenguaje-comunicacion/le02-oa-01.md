# LE02 OA 01 — Leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-01629}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y con combinación ce-ci, que-qui, ge-gi, gue-gui, güe-güi». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-01630}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-01631}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-01632}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-01633}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «leer textos significativos que incluyan palabras con hiatos y diptongos, con grupos consonánticos y…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/2-basico/le02-oa-01)
