# MA02 OA 06 — Describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-01827}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20:completar 10;usar dobles y mitades;"uno más uno menos";"dos más dos menos";usar la reversibilidad de las operaciones». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-01828}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-01829}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-01830}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-01831}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «describir y aplicar estrategias de cálculo mental para adiciones y sustracciones hasta 20» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/2-basico/ma02-oa-06)
