# de Habilidad MA02 OAH a — Resolver problemas
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Matemática | Resolver problemas | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01900}
...
| Explicación | 20 min | Modela cómo abordar «Resolver problemas: Emplear diversas estrategias para resolver problemas: a través de ensayo y error; aplicando conocimientos adquiridos». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01901}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01902}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01903}
