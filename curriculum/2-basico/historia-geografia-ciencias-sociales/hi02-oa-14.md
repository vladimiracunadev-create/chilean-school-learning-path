# HI02 OA 14 — Conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-01325}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para: cuidarse, cuidar a otros y evitar situaciones de riesgo (como seguridad vial, vías de evacuación, adaptaciones para discapacitados, zonas de silencio, etc.) organizar un ambiente propicio al aprendizaje y acogedor para todos (por ejemplo, respetar los turnos, cuidar el espacio y las pertenencias comunes y de sus pares, etc.) cuidar el patrimonio y el medioambiente». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-01326}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-01327}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-01328}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-01329}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «conocer, proponer, aplicar y explicar la importancia de algunas normas necesarias para» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/historia-geografia-ciencias-sociales/2-basico/hi02-oa-14)
