# de Habilidad HI02 OAH f — Obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Historia, Geografía y Ciencias Sociales | Análisis y trabajo con fuentes de información | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01359}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes escritas y orales dadas (narraciones, relatos históricos, leyendas, imágenes, mapas y preguntas a adultos cercanos), mediante preguntas dirigidas». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01360}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01361}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01362}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «obtener información explícita sobre el pasado y el presente a partir de imágenes y de fuentes…» y demostrarlo mediante explicación o indagación con evidencia.
