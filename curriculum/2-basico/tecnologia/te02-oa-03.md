# TE02 OA 03 — Elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Tecnología | Diseñar, hacer y probar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con: técnicas y herramientas para medir, cortar, plegar, unir, pegar, pintar, entre otras materiales como papeles, fibras, plásticos, desechos, entre otros.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02065}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con: técnicas y herramientas para medir, cortar, plegar, unir, pegar, pintar, entre otras materiales como papeles, fibras, plásticos, desechos, entre otros». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02066}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02067}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02068}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «elaborar un objeto tecnológico según indicaciones del profesor, seleccionando y experimentando con» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/2-basico/te02-oa-03)
