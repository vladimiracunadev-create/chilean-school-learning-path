# TE02 OA 07 — Usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Tecnología | Tecnologías de la información y la comunicación | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-02083}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar internet para acceder y extraer información siguiendo las indicaciones del profesor y considerando la seguridad de la fuente». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-02084}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-02085}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-02086}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar internet para acceder y extraer información siguiendo las indicaciones del profesor y…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/2-basico/te02-oa-07)
