# TE02 OA 05 — Usar software de dibujo para crear y representar diferentes ideas por medio de imágenes
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Tecnología | Tecnologías de la información y la comunicación | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02073}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar diferentes ideas por medio de imágenes» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar software de dibujo para crear y representar diferentes ideas por medio de imágenes**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **usar software de dibujo para crear y representar diferentes ideas por medio de imágenes**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02074}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar diferentes ideas por medio de imágenes» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-02075}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar diferentes ideas por medio de imágenes» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02076}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar diferentes ideas por medio de imágenes» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02077}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar software de dibujo para crear y representar diferentes ideas por medio de imágenes» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/2-basico/te02-oa-05)
