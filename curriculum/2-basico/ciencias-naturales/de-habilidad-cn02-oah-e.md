# de Habilidad CN02 OAH e — Comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Ciencias Naturales | Analizar la evidencia y comunicar | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y escrita, y a través de presentaciones, TIC, dibujos, entre otros. Actitud
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01160}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y escrita, y a través de presentaciones, TIC, dibujos, entre otros. Actitud». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01161}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01162}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01163}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «comunicar y comparar con otros sus ideas, observaciones, mediciones y experiencias de forma oral y…» y demostrarlo mediante explicación o indagación con evidencia.
