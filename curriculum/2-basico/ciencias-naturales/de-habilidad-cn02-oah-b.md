# de Habilidad CN02 OAH b — Explorar y experimentar, en forma guiada, con elementos del entorno
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01148}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «explorar y experimentar, en forma guiada, con elementos del entorno» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **explorar y experimentar, en forma guiada, con elementos del entorno**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **explorar y experimentar, en forma guiada, con elementos del entorno**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01149}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «explorar y experimentar, en forma guiada, con elementos del entorno» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01150}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «explorar y experimentar, en forma guiada, con elementos del entorno» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01151}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «explorar y experimentar, en forma guiada, con elementos del entorno» y demostrarlo mediante explicación o indagación con evidencia.
