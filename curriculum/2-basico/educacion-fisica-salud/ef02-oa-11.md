# EF02 OA 11 — Practicar actividades físicas, demostrando comportamientos seguros, como
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Educación Física y Salud | Seguridad, juego limpio y liderazgo | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-01230}
...
| Explicación | 20 min | Modela cómo abordar «Practicar actividades físicas, demostrando comportamientos seguros, como: realizar un calentamiento mediante un juego; escuchar y seguir instrucciones; utilizar implementos bajo supervisión; mantener su posición dentro de los límites establecidos para la actividad». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
### Clase 2 de 5: Comprender y modelar {#cl-01231}
...
### Clase 3 de 5: Practicar con apoyo {#cl-01232}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-01233}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-01234}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/2-basico/ef02-oa-11)
