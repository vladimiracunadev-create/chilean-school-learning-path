# EF02 OA 02 — Ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-01193}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones, representaciones de símbolos, letras, números o figuras geométricas». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-01194}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-01195}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-01196}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «ejecutar acciones motrices que presenten una solución a un problema, por ejemplo, agrupaciones,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/educacion-fisica-salud/2-basico/ef02-oa-02)
