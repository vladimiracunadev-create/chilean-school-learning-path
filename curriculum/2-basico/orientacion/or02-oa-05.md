# OR02 OA 05 — Manifestar actitudes de solidaridad y respeto, que favorezcan la convivencia, como
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° básico | Orientación | Relaciones interpersonales | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-02038}
...
| Explicación | 20 min | Modela cómo abordar «Manifestar actitudes de solidaridad y respeto, que favorezcan la convivencia, como: utilizar formas de buen trato (por ejemplo, saludar, despedirse, pedir por favor); actuar en forma respetuosa (por ejemplo, escuchar, respetar turnos, rutinas y pertenencias); compartir con los pares (por ejemplo, jugar juntos, prestarse útiles, ayudar al que lo necesita)». Hace visible el uso de bienestar, emoción, decisión, vínculo, límite, responsabilidad y red de apoyo y contrasta un ejemplo logrado con el error: forzar exposición personal; confundir consejo con decisión responsable. |
...
### Clase 2 de 5: Comprender y modelar {#cl-02039}
...
### Clase 3 de 5: Practicar con apoyo {#cl-02040}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-02041}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-02042}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/orientacion/2-basico/or02-oa-05)
