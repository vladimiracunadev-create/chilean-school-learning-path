# OR05 OA 01 — Demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05682}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que requiera superar». Hace visible el uso de bienestar, emoción, decisión, vínculo, límite, responsabilidad y red de apoyo y contrasta un ejemplo logrado con el error: forzar exposición personal; confundir consejo con decisión responsable. |
...
| Desempeño individual | 25 min | Cada estudiante produce reflexión o decisión personal fundada en un caso seguro sobre **demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05683}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05684}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05685}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar una valoración positiva de sí mismo reconociendo habilidades, fortalezas y aspectos que…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/orientacion/5-basico/or05-oa-01)
