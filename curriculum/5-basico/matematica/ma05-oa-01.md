# MA05 OA 01 — Representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-05418}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones: identificando el valor posicional de los dígitos componiendo y descomponiendo números naturales en forma estándar y expandida aproximando cantidades comparando y ordenando números naturales en este ámbito numérico dando ejemplos de estos números naturales en contextos reales». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-05419}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-05420}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-05421}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-05422}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «representar y describir números naturales de hasta más de 6 dígitos y menores que 1 000 millones» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/5-basico/ma05-oa-01)
