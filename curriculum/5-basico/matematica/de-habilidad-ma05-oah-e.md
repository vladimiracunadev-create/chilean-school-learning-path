...
| Explicación | 20 min | Modela cómo abordar «Argumentar y comunicar: Comprobar reglas y propiedades». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
