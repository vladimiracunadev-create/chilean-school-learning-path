# MA05 OA 19 — Medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05493}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05494}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05495}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05496}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «medir longitudes con unidades estandarizadas (m, cm, mm) en el contexto de la resolución de problemas» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/matematica/5-basico/ma05-oa-19)
