...
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprenden las fracciones propias» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **demostrar que comprenden las fracciones propias**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Demostrar que comprenden las fracciones propias: representándolas de manera concreta, pictórica y simbólica creando grupos de fracciones equivalentes -simplificando y amplificando- de manera concreta, pictórica y simbólica, de forma manual y/o con software educativo comparando fracciones propias con igual y distinto denominador de manera concreta, pictórica y simbólica». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **demostrar que comprenden las fracciones propias**, explica una decisión y revisa su trabajo con los criterios. |
...
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprenden las fracciones propias» y demostrarlo mediante solución representada, explicada y comprobada.
...
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprenden las fracciones propias» y demostrarlo mediante solución representada, explicada y comprobada.
...
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprenden las fracciones propias» y demostrarlo mediante solución representada, explicada y comprobada.
...
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «demostrar que comprenden las fracciones propias» y demostrarlo mediante solución representada, explicada y comprobada.
