...
| Explicación | 20 min | Modela cómo abordar «Argumentar y comunicar: Identificar un error, explicar su causa y corregirlo». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
