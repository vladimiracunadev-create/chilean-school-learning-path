# de Habilidad HI05 OAH i — Fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-04837}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-04838}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-04839}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-04840}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «fundamentar opiniones respecto de temas estudiados en el nivel, utilizando fuentes, datos y evidencia» y demostrarlo mediante explicación o indagación con evidencia.
