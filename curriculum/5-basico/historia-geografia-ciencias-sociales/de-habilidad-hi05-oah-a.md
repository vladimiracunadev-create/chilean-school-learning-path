# de Habilidad HI05 OAH a — Representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04802}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de tiempo, distinguiendo períodos». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04803}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04804}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04805}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04806}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «representar e interpretar secuencias cronológicas y acontecimientos del pasado mediante líneas de…» y demostrarlo mediante explicación o indagación con evidencia.
