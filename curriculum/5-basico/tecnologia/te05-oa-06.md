# TE05 OA 06 — Usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-05749}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar un documento». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-05750}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-05751}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-05752}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-05753}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar procesador de textos para crear, editar, dar formato, incorporar elementos de diseño y guardar…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/tecnologia/5-basico/te05-oa-06)
