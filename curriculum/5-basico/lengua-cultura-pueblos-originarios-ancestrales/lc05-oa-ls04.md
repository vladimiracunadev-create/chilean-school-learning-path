# LC05 OA LS04 — Desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 5° básico | Lengua y Cultura de los Pueblos Originarios Ancestrales | Contexto de Sensibilización sobre la lengua | segun-contexto-y-normativa | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05160}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en lengua indígena, o en castellano, culturalmente significativas, en diversas situaciones del medio natural, social y cultural». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05161}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05162}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05163}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «desarrollar la escritura para transmitir mensajes que incluyan algunas palabras o expresiones en…» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lengua-cultura-pueblos-originarios-ancestrales/5-basico/lc05-oa-ls04)
