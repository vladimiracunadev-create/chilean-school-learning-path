# EN05 OA 13 — Escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 5° básico | Inglés (Propuesta) | Expresión escrita | propuesta-mineduc | 4 clases de 90 min |

## Qué se debe aprender
> Escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email, postal, agenda, invitación) y textos literarios (cuentos, rimas, tiras cómicas) con el propósito de compartir información en torno a los temas del año.
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-05042}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email, postal, agenda, invitación) y textos literarios (cuentos, rimas, tiras cómicas) con el propósito de compartir información en torno a los temas del año». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-05043}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-05044}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-05045}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como email,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles-propuesta/5-basico/en05-oa-13)
