# AR05 OA 02 — Aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 5° básico | Artes Visuales | Expresar y crear visualmente | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04444}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de arte y diseño con diferentes propósitos expresivos y creativos: color (complementario); formas (abiertas y cerradas); luz y sombra». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04445}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04446}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04447}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04448}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «aplicar y combinar elementos del lenguaje visual (incluidos los de niveles anteriores) en trabajos de…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/artes-visuales/5-basico/ar05-oa-02)
