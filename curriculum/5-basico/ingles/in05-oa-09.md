# IN05 OA 09 — Usar las siguientes estrategias para apoyar la comprensión de los textos leídos, tanto en formato…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 5° básico | Inglés | Comprensión de lectura | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04931}
...
| Explicación | 20 min | Modela cómo abordar «Usar las siguientes estrategias para apoyar la comprensión de los textos leídos, tanto en formato digital como impreso: prelectura: hacer predicciones, basándose en conocimientos previos y elementos visuales lectura: usar organizadores, como títulos, subtítulos, ilustraciones e imágenes poslectura: organizar información en diagramas, releer». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04932}
...
### Clase 3 de 5: Practicar con apoyo {#cl-04933}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04934}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04935}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/5-basico/in05-oa-09)
