# IN05 OA 14 — Completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04954}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios (como postales, mini libros, listas de compras) y textos literarios (como rimas, tiras cómicas) con el propósito de compartir información en torno a los temas del año». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04955}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04956}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04957}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04958}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «completar y escribir, de acuerdo a un modelo y con apoyo de lenguaje visual, textos no literarios…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/5-basico/in05-oa-14)
