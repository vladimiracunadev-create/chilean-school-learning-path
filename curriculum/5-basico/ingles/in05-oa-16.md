# IN05 OA 16 — Utilizar los pasos del proceso de escritura (organización de ideas, escritura, corrección y…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04964}
...
| Explicación | 20 min | Modela cómo abordar «Utilizar los pasos del proceso de escritura (organización de ideas, escritura, corrección y publicación), recurriendo a herramientas como diccionario en línea y procesador de texto, para: escribir oraciones simples y párrafos breves de acuerdo a un modelo y con la ayuda del docente demostrar conocimiento y uso de vocabulario temático de uso cotidiano, palabras de uso frecuente y expresiones de uso común asociadas a las funciones del nivel (por ejemplo: Excuse me, I'm sorry, How old... )». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04965}
...
### Clase 3 de 5: Practicar con apoyo {#cl-04966}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04967}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04968}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/5-basico/in05-oa-16)
