# IN05 OA 06 — Leer comprensivamente textos no literarios, como notas, postales, invitaciones, tarjetas de saludo,…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04917}
...
| Explicación | 20 min | Modela cómo abordar «Leer comprensivamente textos no literarios, como notas, postales, invitaciones, tarjetas de saludo, menús, recetas, diálogos, instrucciones o emails, identificando: propósito del texto ideas generales información explícita palabras clave, expresiones de uso común asociadas a las funciones del nivel (por ejemplo: I'm sorry, excuse me ) y vocabulario temático». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04918}
...
### Clase 3 de 5: Practicar con apoyo {#cl-04919}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04920}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04921}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ingles/5-basico/in05-oa-06)
