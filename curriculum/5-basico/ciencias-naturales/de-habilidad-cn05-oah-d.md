# de Habilidad CN05 OAH d — Medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 5° básico | Ciencias Naturales | Planificar y conducir una investigación | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-04562}
...
| Explicación | 20 min | Modela cómo abordar «Medir y registrar datos en forma precisa con instrumentos de medición, especificando las unidades de medida y comparándolos utilizando tablas, gráficos y TIC cuando corresponda». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
### Clase 2 de 4: Comprender y modelar {#cl-04563}
...
### Clase 3 de 4: Aplicar con autonomía {#cl-04564}
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-04565}
