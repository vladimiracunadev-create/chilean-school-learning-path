# CN05 OA 13 — Analizar y describir las características de los océanos y lagos
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-04547}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «analizar y describir las características de los océanos y lagos» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **analizar y describir las características de los océanos y lagos**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Analizar y describir las características de los océanos y lagos: variación de temperatura, luminosidad y presión en relación con la profundidad diversidad de flora y fauna movimiento de las aguas, como olas, mareas, corrientes (El Niño y Humboldt)». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **analizar y describir las características de los océanos y lagos**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-04548}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «analizar y describir las características de los océanos y lagos» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 5: Practicar con apoyo {#cl-04549}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «analizar y describir las características de los océanos y lagos» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-04550}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «analizar y describir las características de los océanos y lagos» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-04551}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «analizar y describir las características de los océanos y lagos» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/5-basico/cn05-oa-13)
