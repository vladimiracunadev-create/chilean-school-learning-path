# CN05 OA 09 — Construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-04530}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…» y demostrarlo mediante explicación o indagación con evidencia.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver problemas cotidianos y explicar su funcionamiento». Hace visible el uso de pregunta, variable, observación, evidencia, patrón, modelo y limitación y contrasta un ejemplo logrado con el error: tratar opiniones como evidencia; cambiar varias variables. |
...
| Desempeño individual | 25 min | Cada estudiante produce explicación o indagación con evidencia sobre **construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-04531}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-04532}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…» y demostrarlo mediante explicación o indagación con evidencia.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-04533}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «construir un circuito eléctrico simple (cable, ampolleta, interruptor y pila), usarlo para resolver…» y demostrarlo mediante explicación o indagación con evidencia.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/ciencias-naturales/5-basico/cn05-oa-09)
