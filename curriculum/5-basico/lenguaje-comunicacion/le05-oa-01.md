# LE05 OA 01 — Leer de manera fluida textos variados apropiados a su edad
...
## Lecturas y textos
- [Audiolibro: ¿¿¿Pippiloteca??? Una biblioteca maravillosa](https://www.curriculumnacional.cl/recursos/audiolibro-pippiloteca-biblioteca-maravillosa) — lectura vinculada por MINEDUC.
- [Audiolibro: ¿Me ayudas, gatito?](https://www.curriculumnacional.cl/recursos/audiolibro-ayudas-gatito) — lectura vinculada por MINEDUC.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-05223}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «leer de manera fluida textos variados apropiados a su edad» y demostrarlo mediante interpretación o producción comunicativa fundamentada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **leer de manera fluida textos variados apropiados a su edad**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Leer de manera fluida textos variados apropiados a su edad: pronunciando las palabras con precisión respetando la prosodia indicada por todos los signos de puntuación decodificando de manera automática la mayoría de las palabras del texto». Hace visible el uso de propósito, evidencia, inferencia, estructura, audiencia y revisión y contrasta un ejemplo logrado con el error: resumir en vez de interpretar; opinar sin evidencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce interpretación o producción comunicativa fundamentada sobre **leer de manera fluida textos variados apropiados a su edad**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-05224}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «leer de manera fluida textos variados apropiados a su edad» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-05225}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «leer de manera fluida textos variados apropiados a su edad» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-05226}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «leer de manera fluida textos variados apropiados a su edad» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-05227}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «leer de manera fluida textos variados apropiados a su edad» y demostrarlo mediante interpretación o producción comunicativa fundamentada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/1o-6o-basico/lenguaje-comunicacion/5-basico/le05-oa-01)
