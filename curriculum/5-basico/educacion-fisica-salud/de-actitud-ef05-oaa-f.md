# de Actitud EF05 OAA F — Respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-04684}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Respetar la diversidad física de las personas, sin discriminar por características como altura, peso, color de piel o pelo, etc». Hace visible el uso de habilidad motriz, control, coordinación, intensidad, seguridad, estrategia y autocuidado y contrasta un ejemplo logrado con el error: priorizar velocidad sobre control; omitir calentamiento, hidratación o reglas de seguridad. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño motriz seguro observado con una pauta sobre **respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-04685}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-04686}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-04687}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «respetar la diversidad física de las personas, sin discriminar por características como altura, peso,…» y demostrarlo mediante desempeño motriz seguro observado con una pauta.
