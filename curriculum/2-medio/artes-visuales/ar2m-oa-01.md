# AR2M OA 01 — Crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Artes Visuales | Expresar y crear visualmente | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-10837}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a problemáticas sociales y juveniles, en el espacio público y en diferentes contextos». Hace visible el uso de elementos, técnica, materialidad, intención, contexto, proceso y apreciación y contrasta un ejemplo logrado con el error: copiar un modelo sin tomar decisiones; confundir preferencia con apreciación fundamentada. |
...
| Desempeño individual | 25 min | Cada estudiante produce creación artística acompañada de decisiones explicadas sobre **crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-10838}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 3 de 5: Practicar con apoyo {#cl-10839}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-10840}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-10841}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «crear proyectos visuales basados en la valoración crítica de manifestaciones estéticas referidas a…» y demostrarlo mediante creación artística acompañada de decisiones explicadas.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/artes-visuales/2-medio/ar2m-oa-01)
- [Asignatura y nivel](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/artes-visuales/2-medio)
- Snapshot: 2026-09-24
