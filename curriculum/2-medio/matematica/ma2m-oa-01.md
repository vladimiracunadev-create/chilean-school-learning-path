# MA2M OA 01 — Realizar cálculos y estimaciones que involucren operaciones con números reales
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Matemática | Números | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-11726}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «realizar cálculos y estimaciones que involucren operaciones con números reales» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **realizar cálculos y estimaciones que involucren operaciones con números reales**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Realizar cálculos y estimaciones que involucren operaciones con números reales: Utilizando la descomposición de raíces y las propiedades de las raíces. Combinando raíces con números racionales. Resolviendo problemas que involucren estas operaciones en contextos diversos». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **realizar cálculos y estimaciones que involucren operaciones con números reales**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-11727}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «realizar cálculos y estimaciones que involucren operaciones con números reales» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 5: Practicar con apoyo {#cl-11728}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «realizar cálculos y estimaciones que involucren operaciones con números reales» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-11729}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «realizar cálculos y estimaciones que involucren operaciones con números reales» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-11730}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «realizar cálculos y estimaciones que involucren operaciones con números reales» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/2-medio/ma2m-oa-01)
