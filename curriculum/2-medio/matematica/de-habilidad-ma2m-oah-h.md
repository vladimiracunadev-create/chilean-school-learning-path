# de Habilidad MA2M OAH h — Usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Matemática | Modelar | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-11810}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar patrones y fenómenos de la ciencia y la realidad». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-11811}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-11812}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-11813}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «usar modelos, utilizando un lenguaje funcional para resolver problemas cotidianos y para representar…» y demostrarlo mediante solución representada, explicada y comprobada.
