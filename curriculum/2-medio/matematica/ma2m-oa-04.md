# MA2M OA 04 — Resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Matemática | Álgebra y funciones | formacion-general-comun | 4 clases de 90 min |

## Qué se debe aprender
> Resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones cuadráticas de la forma: ax 2 = b (ax + b) 2 = c ax 2 + bx = 0 ax 2 + bx = c (a, b, c son números racionales, a ≠ 0)
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-11741}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…» y demostrarlo mediante solución representada, explicada y comprobada.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones cuadráticas de la forma: ax 2 = b (ax + b) 2 = c ax 2 + bx = 0 ax 2 + bx = c (a, b, c son números racionales, a ≠ 0)». Hace visible el uso de datos, representación, estrategia, estimación y verificación y contrasta un ejemplo logrado con el error: aplicar reglas sin reconocer cuándo sirven; aceptar resultados sin estimarlos. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución representada, explicada y comprobada sobre **resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-11742}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-11743}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…» y demostrarlo mediante solución representada, explicada y comprobada.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-11744}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «resolver, de manera concreta, pictórica y simbólica, o usando herramientas tecnológicas, ecuaciones…» y demostrarlo mediante solución representada, explicada y comprobada.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/matematica/2-medio/ma2m-oa-04)
