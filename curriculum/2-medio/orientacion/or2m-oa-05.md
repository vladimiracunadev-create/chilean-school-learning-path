# OR2M OA 05 — Promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Orientación | Relaciones interpersonales | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-11960}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio de las redes sociales, sobre la base del análisis de situaciones, considerando los derechos de las personas acorde a los principios de igualdad, dignidad, inclusión y no discriminación». Hace visible el uso de bienestar, emoción, decisión, vínculo, límite, responsabilidad y red de apoyo y contrasta un ejemplo logrado con el error: forzar exposición personal; confundir consejo con decisión responsable. |
...
| Desempeño individual | 25 min | Cada estudiante produce reflexión o decisión personal fundada en un caso seguro sobre **promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-11961}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 3 de 5: Practicar con apoyo {#cl-11962}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-11963}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-11964}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «promover en su entorno relaciones interpersonales constructivas, sean estas presenciales o por medio…» y demostrarlo mediante reflexión o decisión personal fundada en un caso seguro.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/orientacion/2-medio/or2m-oa-05)
