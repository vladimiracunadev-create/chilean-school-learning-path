# IN2M OA 15 — Escribir para analizar, expresar opiniones y narrar, usando
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Inglés | Expresión escrita | formacion-general-comun | 6 clases de 90 min |
...
### Clase 1 de 6: Conectar y diagnosticar {#cl-11449}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir para analizar, expresar opiniones y narrar, usando**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir para analizar, expresar opiniones y narrar, usando: Variedad de palabras, oraciones y estructuras aprendidas y de otros contextos. Conectores variados. Correcta ortografía de palabras de uso frecuente en forma consistente. Puntuación apropiada (comillas)». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir para analizar, expresar opiniones y narrar, usando**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 6: Comprender y modelar {#cl-11450}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 6: Practicar con apoyo {#cl-11451}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 6: Aplicar con autonomía {#cl-11452}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 6: Contrastar y profundizar {#cl-11453}
**Foco:** comparar alternativas y examinar casos límite. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 6 de 6: Demostrar y retroalimentar {#cl-11454}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir para analizar, expresar opiniones y narrar, usando» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/2-medio/in2m-oa-15)
