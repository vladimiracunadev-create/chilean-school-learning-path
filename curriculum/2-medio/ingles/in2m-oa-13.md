# IN2M OA 13 — Escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-11439}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y efectiva que refuercen el mensaje en textos variados, acerca de temas como: Experiencias personales. Contenidos interdisciplinarios. Aspectos de interés global. Cultura de otros países. Textos leídos». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-11440}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 5: Practicar con apoyo {#cl-11441}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-11442}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-11443}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir historias e información relevante, usando diversos recursos multimodales en forma creativa y…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/2-medio/in2m-oa-13)
