# IN2M OA 14 — Escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Inglés | Expresión escrita | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-11444}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…» y demostrarlo mediante desempeño comunicativo comprensible.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas, descripciones, biografías, instrucciones, cartas, resúmenes, diario personal ( journal ) y poemas o canciones utilizando los pasos del proceso de escritura (organizar ideas, redactar, revisar, editar, publicar), generalmente en forma independiente de acuerdo a un criterio de evaluación, recurriendo a herramientas como el procesador de textos y diccionario en línea». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
| Desempeño individual | 25 min | Cada estudiante produce desempeño comunicativo comprensible sobre **escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-11445}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 3 de 5: Practicar con apoyo {#cl-11446}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-11447}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-11448}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «escribir una variedad de textos, como cuentos, correos electrónicos, artículos, folletos, rimas,…» y demostrarlo mediante desempeño comunicativo comprensible.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles/2-medio/in2m-oa-14)
