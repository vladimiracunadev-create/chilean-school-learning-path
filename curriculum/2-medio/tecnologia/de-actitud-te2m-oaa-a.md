# de Actitud TE2M OAA A — Respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-12018}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo colaborativo exigido en la producción de soluciones tecnológicas, en la reflexión y el debate sobre el análisis de productos tecnológicos, en la conservación de los recursos y del bien común, entre otros». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-12019}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-12020}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-12021}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-12022}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «respetar al otro y al medio ambiente, lo que se expresa en los requerimientos del trabajo…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
