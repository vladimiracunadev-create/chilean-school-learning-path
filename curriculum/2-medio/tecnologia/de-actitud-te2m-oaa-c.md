# de Actitud TE2M OAA C — Trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Tecnología | Actitudes | formacion-general-comun | 5 clases de 90 min |
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-12027}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos del equipo; en asumir responsabilidades en el grupo y establecer maneras de trabajo eficiente; en aceptar consejos y críticas, escuchando y respetando al otro para llegar a acuerdos; en tomar conciencia y superar las dificultades personales y del trabajo; en aprender de los errores; en solicitar y prestar ayuda a sus pares para el cumplimiento de las metas del trabajo». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 5: Comprender y modelar {#cl-12028}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 5: Practicar con apoyo {#cl-12029}
**Foco:** ensayar con andamiaje y retroalimentación inmediata. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 5: Aplicar con autonomía {#cl-12030}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-12031}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «trabajar colaborativamente, lo que se refleja en el compromiso por la prosecución de los objetivos…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/tecnologia/2-medio)
