# de Actitud TE2M OAA B — Valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Tecnología | Actitudes | formacion-general-comun | 4 clases de 90 min |
...
### Clase 1 de 4: Conectar y diagnosticar {#cl-12023}
**Foco:** recuperar ideas previas y detectar barreras. **Meta para estudiantes:** hoy voy a trabajar «valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.

| Momento | Tiempo | Acción docente y experiencia |
|---|---:|---|
| Inicio | 10 min | Presenta una situación breve vinculada a **valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…**. Recupera qué saben y registra una respuesta inicial de todo el curso. |
| Explicación | 20 min | Modela cómo abordar «Valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas y tecnológicas, de los desarrollos tecnológicos en virtud de su aporte al mejoramiento de la calidad de vida, con todo lo que su producción requiere». Hace visible el uso de necesidad, usuario, criterio, restricción, diseño, prototipo, prueba e impacto y contrasta un ejemplo logrado con el error: construir antes de definir el problema; evaluar solo por apariencia. |
...
| Desempeño individual | 25 min | Cada estudiante produce solución tecnológica justificada y probada contra criterios sobre **valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…**, explica una decisión y revisa su trabajo con los criterios. |
...
### Clase 2 de 4: Comprender y modelar {#cl-12024}
**Foco:** explicar con ejemplo y contraejemplo, haciendo visible el pensamiento experto. **Meta para estudiantes:** hoy voy a trabajar «valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 3 de 4: Aplicar con autonomía {#cl-12025}
**Foco:** resolver una situación nueva y justificar decisiones. **Meta para estudiantes:** hoy voy a trabajar «valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
...
### Clase 4 de 4: Demostrar y retroalimentar {#cl-12026}
**Foco:** producir evidencia final y decidir el paso siguiente. **Meta para estudiantes:** hoy voy a trabajar «valorar las potencialidades propias y del otro, en relación con el desarrollo de capacidades técnicas…» y demostrarlo mediante solución tecnológica justificada y probada contra criterios.
