# EN2M OA 11 — Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos,…
| Nivel | Asignatura | Tema/eje | Cobertura | Dosificación |
|---|---|---|---|---|
| 2° medio | Inglés (Propuesta) | Expresión escrita | propuesta-mineduc | 5 clases de 90 min |

## Qué se debe aprender
> Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos, correos electrónicos, folletos, noticias, descripciones, biografías, instrucciones, artículos, resúmenes, diario personal (journal), usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales. contenidos interdisciplinarios. aspectos de interés global. cultura de otros países. textos leídos.
...
### Clase 1 de 5: Conectar y diagnosticar {#cl-11531}
...
| Explicación | 20 min | Modela cómo abordar «Escribir de acuerdo a un modelo y a un criterio de evaluación, una variedad de textos como cuentos, correos electrónicos, folletos, noticias, descripciones, biografías, instrucciones, artículos, resúmenes, diario personal (journal), usando recursos multimodales que refuercen el mensaje en forma creativa, acerca de temas como: experiencias personales. contenidos interdisciplinarios. aspectos de interés global. cultura de otros países. textos leídos». Hace visible el uso de purpose, audience, key words, meaning, interaction y revision y contrasta un ejemplo logrado con el error: traducir literalmente; esperar precisión total antes de comunicarse. |
...
### Clase 2 de 5: Comprender y modelar {#cl-11532}
...
### Clase 3 de 5: Practicar con apoyo {#cl-11533}
...
### Clase 4 de 5: Aplicar con autonomía {#cl-11534}
...
### Clase 5 de 5: Demostrar y retroalimentar {#cl-11535}
...
## Fuente
- [Ficha oficial del OA](https://www.curriculumnacional.cl/curriculum/7o-basico-2o-medio/ingles-propuesta/2-medio/en2m-oa-11)
